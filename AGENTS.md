...
- **Windows setup scripts**: `orca.yaml` setup and issue-command runners are `.cmd` except for Git Bash and WSL, which get `.sh`. See [`docs/reference/windows-setup-shell.md`](./docs/reference/windows-setup-shell.md).

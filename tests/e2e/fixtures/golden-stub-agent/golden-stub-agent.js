...
const idleTitleMode = process.argv.includes('--idle-title')
...
function render() {
  ...
  process.stdout.write(
    `${keyboardProtocolMode ? '\x1b]0;\u280b Codex is thinking\x07\x1b[>1u' : idleTitleMode ? '\x1b]0;Codex ready\x07' : '\x1b]0;Golden Stub Agent\x07'}${[

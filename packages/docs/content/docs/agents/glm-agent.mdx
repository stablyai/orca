...
These settings follow [Z.ai's latest model guide](https://docs.z.ai/devpack/latest-model). Check that page for the current provider-side details.
</Callout>
...
1. Point Orca at the harness binary or launch command.
1. Save it, then start it from the agent picker in any worktree.

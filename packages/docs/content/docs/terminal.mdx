...
<ImagePlaceholder src="/whats-new/ghostty-style-terminal.gif" caption="Ghostty-style terminal — import your Ghostty theme, font, and cursor on first launch" />
...
Agent terminal tabs show the agent identity plus live state: working, waiting for input, completed, or completed-but-unread.
...
<ImagePlaceholder src="/whats-new/keyboard-native.gif" caption="Native key bindings via the kitty keyboard protocol — Shift+Enter and friends reach the agent CLI exactly like in your standalone terminal." />

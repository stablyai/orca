...
<ImagePlaceholder src="/whats-new/session-that-survives-restart.gif" caption="Restart Orca and the session — terminals, splits, scrollback, focused tab — comes back intact." />

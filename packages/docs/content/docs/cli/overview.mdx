...
See [Skills registry & MCP](/docs/cli/skills) for every installable Orca skill.

<ImagePlaceholder src="/whats-new/orca-cli-demo.gif" caption="Orca CLI — drive worktrees, terminals, and the built-in browser from any shell" />

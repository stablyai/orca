...
<ImagePlaceholder src="/docs/orca-split-screen.gif" caption="Hero walkthrough — split pane with three agents, one per worktree" />
...
<ImagePlaceholder src="/whats-new/default-agent-opening.gif" caption="One-click workspace launcher — pick an agent or open an empty terminal. Customize the default in Settings." />

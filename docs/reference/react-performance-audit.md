...
Open medium-risk PRs #3070, #3073, and #3077 each lower their branch count to 935 Effect hook call sites; open medium-risk PR #3079 lowers its branch count to 926; open high-risk PR #3075 lowers its branch count to 932; and open high-risk PR #3081 lowers its branch count to 928. These are not counted in the merged baseline until reviewed and merged.

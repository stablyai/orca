...
<p align="center">
  <a href="https://github.com/mcode-ide/mcode"><img src="https://img.shields.io/github/stars/mcode-ide/mcode?style=flat&amp;label=%E2%98%85&amp;color=08C" alt="GitHub Star 数" /></a>
  <a href="https://github.com/mcode-ide/mcode/releases"><img src="../assets/readme-downloads.svg" alt="所有版本的总下载量" /></a>
  <img src="https://img.shields.io/badge/license-MIT-08C?style=flat" alt="许可证: MIT" />
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="加入 MCode Discord" /></a>
  <a href="https://x.com/mcode_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="在 X 上关注 MCode" /></a>
...
<h3 align="center"><a href="https://mcode.dev/download"><ins>下载 MCode</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="MCode 桌面应用在并行 worktree 中运行智能体，角落里是 MCode 移动 companion 应用" width="960" />
</p>
...
[iOS App Store](https://apps.apple.com/us/app/mcode-ide/id6766130217) · [Android APK](https://github.com/mcode-ide/mcode/releases/download/mobile-android-v0.0.43/app-release.apk) · [文档 →](https://www.mcode.dev/docs/mobile)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="MCode 桌面端与移动 companion 应用" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/model/worktrees)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/model/worktrees"><picture><source srcset="../assets/feature-wall/parallel-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/parallel-worktrees.jpg" alt="并行 worktree 编排" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/terminal)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/terminal"><picture><source srcset="../assets/feature-wall/terminal-splits.gif" type="image/gif"><img src="../assets/feature-wall/terminal-splits.jpg" alt="终端分屏" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/browser/design-mode)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/browser/design-mode"><picture><source srcset="../assets/feature-wall/design-mode.gif" type="image/gif"><img src="../assets/feature-wall/design-mode.jpg" alt="内置浏览器与设计模式" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/review/linear)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="MCode 中的 GitHub 与 Linear 任务工作流" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/ssh)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/ssh"><picture><source srcset="../assets/feature-wall/ssh-worktrees.gif" type="image/gif"><img src="../assets/feature-wall/ssh-worktrees.jpg" alt="通过 SSH 使用远程 worktree" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任意 diff 行上添加评论并发回给智能体 — 评审、编辑、提交，全程无需离开 MCode。

[文档 →](https://www.mcode.dev/docs/review/annotate-ai-diff)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/review/annotate-ai-diff"><picture><source srcset="../assets/feature-wall/annotate-diff.gif" type="image/gif"><img src="../assets/feature-wall/annotate-diff.jpg" alt="标注 AI 生成的 diff" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://www.mcode.dev/docs/editing/file-explorer)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/editing/file-explorer"><picture><source srcset="../assets/feature-wall/file-drag.gif" type="image/gif"><img src="../assets/feature-wall/file-drag.jpg" alt="将文件和图片拖入智能体提示" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
智能体也能驱动 MCode — 用 `mcode worktree create`、`snapshot`、`click` 和 `fill` 把每个工作流脚本化。

[文档 →](https://www.mcode.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.mcode.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/mcode-cli.gif" type="image/gif"><img src="../assets/feature-wall/mcode-cli.jpg" alt="从 CLI 脚本化 MCode" width="100%" /></picture></a>
</td>
</tr>
</table>
...
- **[快速打开](https://www.mcode.dev/docs/model/quick-open)** — 在 worktree、文件、智能体、命令和仓库上下文之间搜索，不打断你的心流。
- **[账号切换与用量追踪](https://www.mcode.dev/docs/agents/usage-tracking)** — 查看 Claude 和 Codex 的用量与限额重置时间，并且无需重新登录即可热切换账号。
- **[丰富仓库预览](https://www.mcode.dev/docs/editing/markdown)** — 在工作区中预览 Markdown、图片、PDF 和仓库文档。
- **[Computer Use](https://www.mcode.dev/docs/cli/computer-use)** — 当工作流需要真实交互时，让智能体操作桌面应用和可见 UI。
- **[通知与未读状态](https://www.mcode.dev/docs/notifications)** — 第一时间知道智能体何时完成或需要关注，并可将会话标记为未读，稍后再回来处理。
- **还有很多很多** — 我们每天发布新功能，这个列表永远跟不上。[更新日志](https://github.com/mcode-ide/mcode/releases)才是真正的功能列表。

---

## 支持的智能体

适配**任何 CLI 智能体** — 只要能在终端里运行，就能在 MCode 里运行。
...
- **[从 MCode.dev 下载](https://mcode.dev/download)**
- 或直接获取安装包：[macOS Apple Silicon](https://github.com/mcode-ide/mcode/releases/latest/download/mcode-macos-arm64.dmg) · [macOS Intel](https://github.com/mcode-ide/mcode/releases/latest/download/mcode-macos-x64.dmg) · [Windows (.exe)](https://github.com/mcode-ide/mcode/releases/latest/download/mcode-windows-setup.exe) · [Linux AppImage](https://github.com/mcode-ide/mcode/releases/latest/download/mcode-linux.AppImage) · [全部构建](https://github.com/mcode-ide/mcode/releases/latest)
...
- **iOS:** [从 App Store 下载](https://apps.apple.com/us/app/mcode-ide/id6766130217)
- **Android:** [下载 APK](https://github.com/mcode-ide/mcode/releases/download/mobile-android-v0.0.43/app-release.apk)
...
- **Twitter / X:** 关注 **[@mcode_build](https://x.com/mcode_build)** 获取更新和公告。
- **微信:** 扫码加入 MCode 社区微信第 7 群。如果第 7 群已满，请使用第 8 群。

  <img src="../assets/wechat-qr-group7.jpg" alt="MCode 社区微信第 7 群二维码" width="160" />&nbsp;&nbsp;
  <img src="../assets/wechat-qr-group8.jpg" alt="MCode 社区微信第 8 群二维码" width="160" />

- **反馈与想法:** 我们发布很快。缺少什么功能？[提交功能请求](https://github.com/mcode-ide/mcode/issues)。
- **隐私:** 查看[隐私与遥测文档](https://www.mcode.dev/docs/telemetry)，了解 MCode 收集哪些匿名使用数据以及如何退出。
- **支持我们:** 给这个仓库点 [Star](https://github.com/mcode-ide/mcode)，关注我们的日常发布。
...
<a href="https://github.com/mcode-ide/mcode/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=mcode-ide/mcode" alt="MCode 贡献者" />
</a>

## 许可证

MCode 是自由且开源的软件，遵循 [MIT 许可证](../../LICENSE)。

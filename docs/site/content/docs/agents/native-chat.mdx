...
- On desktop, choose whether **Enter** sends or inserts a newline under **Settings → Experimental → Chat UI → Send messages with**. In modifier mode, use **⌘ Enter** on macOS or **Ctrl+Enter** on Windows/Linux to send.

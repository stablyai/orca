...
| Reasonix           | Auto-setup via the installed `reasonix` executable (npm `reasonix`, Node 18+ for the npm path); DeepSeek-native agent      | [Reasonix](https://github.com/esengine/DeepSeek-Reasonix)                                         |

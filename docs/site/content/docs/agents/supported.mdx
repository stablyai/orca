...
| Polytoken          | Auto-setup, hooks, status, active-session resume, source-control AI; macOS/Linux/WSL/SSH (not native Windows)              | [Polytoken](https://docs.polytoken.dev/installation/)                                             |

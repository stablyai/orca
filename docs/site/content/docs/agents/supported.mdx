...
| Reasonix           | Auto-setup via the installed `reasonix` executable (npm `reasonix`, Node 22+); DeepSeek-native agent                       | [Reasonix](https://github.com/esengine/DeepSeek-Reasonix)                                         |

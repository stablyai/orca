...
- **Default Markdown View** — which view `.md` files open in: **Source**, **Rich Editor** (the default), or **Preview**. Persists across restarts. Switching views inside a tab still only affects that tab. You can also set it by right-clicking inside any Markdown editor or preview.

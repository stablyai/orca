...
The tab's view toggle offers **Source**, **Rich Editor**, and **Preview**, and that choice applies to that tab only. To change which view every `.md` file opens in, set **Settings → General → Default Markdown View**, or right-click inside a Markdown editor or preview and pick from **Default Markdown View**. The preference is saved, so it survives a restart.

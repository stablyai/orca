...
Turning the switch off, or unpairing the phone from the desktop, deletes the token from the push service. Two sub-switches let you receive only **Needs input** or only **Task finished** alerts.

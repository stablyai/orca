...
// The boundary is for the route chunks the manifest defers; expo-router puts one around each
// screen too, so this one only catches a suspend raised above them.

...
import { createTaskScreenStyles } from './task-screen-styles'
...
function createProviderOptions(colors: ThemeColors): PickerOption<TaskProvider>[] {
  return [
    {
      value: 'github',
      label: 'GitHub',
...
type MobileTasksStyles = ReturnType<typeof createTaskScreenStyles>

function renderCommentReactions(comment: DetailComment, styles: MobileTasksStyles): ReactNode {
...
function GitHubPrFileDiff({
  ...
  const styles = useThemedStyles(createTaskScreenStyles)
...
function getGitLabPipelineStatusStyle(status: string, styles: MobileTasksStyles) {
  switch (status) {
    case 'success':

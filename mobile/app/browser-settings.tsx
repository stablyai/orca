...
function buildLinkModeOptions(
  t: (key: string, fallback: string) => string
): PickerOption<MobileTerminalLinkOpenMode>[] {
  return [
    {
      value: 'orca-browser',
      label: t('mobile.browserSettings.linkModeOrcaBrowser', 'Orca browser on desktop'),
      subtitle: t(
        'mobile.browserSettings.linkModeOrcaBrowserSub',
        'Open in the streamed browser from your paired desktop.'
      )
    },
    {
      value: 'phone-browser',
      label: t('mobile.browserSettings.linkModePhoneBrowser', 'Phone browser'),
      subtitle: t(
        'mobile.browserSettings.linkModePhoneBrowserSub',
...
export default function BrowserSettingsScreen(): React.JSX.Element {
  ...
  const linkModeOptions = buildLinkModeOptions(t)
  ...
  const linkModeLabel = (mode: MobileTerminalLinkOpenMode): string => {
    return (
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      <View style={styles.topRow}>
        ...
        <Text style={styles.heading}>{t('mobile.browserSettings.title', 'Browser')}</Text>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.groupHeading}>{t('mobile.browserSettings.links', 'LINKS')}</Text>
        <Text style={styles.groupDescription}>
          {t(
            'mobile.browserSettings.linksDesc',
          ...
          >
            ...
            <View style={styles.rowContent}>
              <Text style={styles.rowLabel}>
                {t('mobile.browserSettings.openLinksLabel', 'Open terminal links')}
              </Text>
      ...
      <PickerModal<MobileTerminalLinkOpenMode>
        visible={pickerOpen}
        title={t('mobile.browserSettings.openLinksLabel', 'Open terminal links')}

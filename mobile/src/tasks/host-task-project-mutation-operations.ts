...
import type { GitHubProjectFieldMutationValue } from './mobile-tasks-view-state-types'
...
export type HostTaskProjectMutationOperations = {
  ...
  addComment(target: HostTaskProjectItemTarget, body: string): Promise<DetailComment | undefined>

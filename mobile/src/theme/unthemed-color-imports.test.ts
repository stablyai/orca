...
const UNTHEMED_COLOR_IMPORTERS: readonly string[] = [
  ...
  'src/components/HostRouteNoticeBanner.tsx',
  ...
  'src/components/WorktreeAgentSummary.tsx',
  ...
  'src/session/MobileNativeChatComposerSuggestions.tsx',
  ...
  'src/session/MobileNativeChatSessionOptionPickers.tsx',
  'src/session/MobileNativeChatSessionOptionRows.tsx',
  ...
  'src/session/QuickCommandsTabButton.tsx',
  ...
  'src/session/mobile-session-frame-styles.ts',
  'src/session/mobile-session-reader-styles.ts',
  'src/session/mobile-session-review-comment-styles.ts',

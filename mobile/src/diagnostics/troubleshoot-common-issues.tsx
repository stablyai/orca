...
// Why a function of colors: icons need the resolved palette; a module-const
// would freeze darkColors at import time.
export function getTroubleshootCommonIssues(colors: ThemeColors): TroubleshootSection[] {
  return [
    {
      id: 'wifi',

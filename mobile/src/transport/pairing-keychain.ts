...
const GENERATION_STORAGE_KEY = 'mcode:pairing-keychain-generation'
const PRESENCE_STORAGE_PREFIX = 'mcode:pairing-keychain-presence:'
const SERVICE_PREFIX = 'mcode.pairing.v'

...
// One row of a rendered diff, with its inline note thread. Lifted out of the session screen
// because the row owns a whole comment-draft interaction of its own.

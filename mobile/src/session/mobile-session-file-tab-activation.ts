...
export type MobileSessionFileTabActivationResult = 'activated' | 'cancelled' | 'timeout'

const TAB_POLL_DELAYS_MS = [0, 300, 600, 900] as const

export async function activateMobileSessionFileTab(
  options: Options
): Promise<MobileSessionFileTabActivationResult> {

...
export const createMobileSourceControlBaseStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    container: {
      flex: 1,
...
export const createMobileSourceControlStyles = (colors: ThemeColors) => ({
  ...createMobileSourceControlBaseStyles(colors),
  ...createMobileSourceControlListStyles(colors),
  ...createMobileSourceControlDiffStyles(colors)
})

...
// Extracted from TerminalShortcutSettings.tsx, which sat at 399/400 lines. Values unchanged.
export const createTerminalShortcutSettingsStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    groupHeading: {
      fontSize: 11,
      fontWeight: '600',

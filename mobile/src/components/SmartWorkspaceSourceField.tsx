...
export function SmartWorkspaceSourceField({
  ...
  const styles = useThemedStyles(createSmartWorkspaceSourceFieldStyles)
    ...
    <View style={styles.field}>
      ...
      {selection ? (
        <View style={styles.pill}>
          <SelectionIcon kind={selection.kind} colors={colors} />
...
export const createSmartWorkspaceSourceFieldStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    field: {

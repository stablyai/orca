...
<h1 align="center">
  <a href="https://MCode.dev"><img src="resources/build/icon.png" alt="MCode" width="64" /></a>
  MCode
</h1>

<p align="center">
  <a href="https://github.com/mcode-ide/mcode/stargazers"><img src="https://badgen.net/github/stars/mcode-ide/mcode" alt="GitHub stars" /></a>
  <strong>The AI Orchestrator</strong><br/>
  Run Codex side-by-side.
</p>
`)

    expect(normalized).toContain('# [MCode](https://MCode.dev)')
    expect(normalized).toContain('[GitHub stars](https://github.com/mcode-ide/mcode/stargazers)')
  ...
  it('preserves non-tag angle bracket prose while stripping known HTML tags', () => {
    ...
    expect(normalizeMobileMarkdownPreviewHtml('<mailto:mcode@example.com>')).toBe(
      '<mailto:mcode@example.com>'
    )
  ...
  it('does not replace literal code placeholder text in markdown prose', () => {
    const literalPlaceholder = '\uE000MCODE_MD_CODE_0\uE000'

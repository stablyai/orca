...
export type TaskProviderLogoKind = 'github' | 'gitlab' | 'linear' | 'jira'
  ...
  if (provider === 'jira') {
    return (
      <Svg
        ...
        fill={color}
      >
        {/* Why: flattened Jira product mark, matching the desktop JiraIcon so the
        provider row stays monochrome instead of rendering as a branded tile. */}

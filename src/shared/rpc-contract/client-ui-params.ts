...
export const UiUpdateFields = z
  .object({
    ...
    statusBarUsageBarsVisible: z.boolean().optional(),
    statusBarUsageChipDisplayWord: z.boolean().optional(),
    statusBarUsageChipTightDuration: z.boolean().optional(),
    statusBarUsageChipWindowLabel: z.boolean().optional(),

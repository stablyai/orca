...
export function createMobileRelayPairingFixtures(now: number): PairingFixture[] {
  ...
  return [
    ...
    },
    {
      ...
      payload: { ...directOffer, relay: { ...relay, directorUrl: 'https://relay.mcode.dev/' } },
      expected: null
    },
    {
      name: 'non-HTTPS cell origin is invalid',
      payload: { ...directOffer, relay: { ...relay, cellUrl: 'http://relay-c1.mcode.dev' } },
      expected: null
    },
    {

...
export type GlobalSettings = {
  ...
  /** Why: one-shot guard to make Volo visible for existing profiles once, without re-adding after a later opt-out. */
  visibleTaskProvidersDefaultedForVolo: boolean

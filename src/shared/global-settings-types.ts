...
export type GlobalSettings = {
  ...
  /** Why: same one-shot guard for Odoo. A profile saved before Odoo existed holds a
   *  provider list that predates it, and a stored list is filtered, never extended. */
  visibleTaskProvidersDefaultedForOdoo: boolean

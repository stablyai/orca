...
export type GlobalSettings = {
  ...
  /** Why: one-shot guard to make Shortcut visible for existing profiles once, without re-adding after a later opt-out. */
  visibleTaskProvidersDefaultedForShortcut: boolean

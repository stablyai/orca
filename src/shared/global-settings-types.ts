...
export type GlobalSettings = {
  ...
  /** Collapse single-child folder chains into one row in Source Control trees (VS Code's compact folders). Defaults on to match the pre-preference rendering. Per-user, not per-workspace. */

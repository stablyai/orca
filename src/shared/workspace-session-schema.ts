...
import {
  archivedForkableAgentSessionsByPaneKeySchema,
  sleepingAgentSessionsByPaneKeySchema
} from './workspace-session-agent-session-schemas'
...
export const workspaceSessionStateSchema: z.ZodType<WorkspaceSessionState> = z.object({
  ...
  archivedForkableAgentSessionsByPaneKey: archivedForkableAgentSessionsByPaneKeySchema
})

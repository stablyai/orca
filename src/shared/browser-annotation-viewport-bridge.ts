...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__mcode_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__mcodeBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-mcode-browser-annotation-overlay';
  const markerSize = 24;

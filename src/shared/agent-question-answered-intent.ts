 ...
 *  `request_user_input` and `request_user_input_async` (same questions/options input shape).
...
export function isAsyncUserInputTool(toolName: string | undefined): boolean {

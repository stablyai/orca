import type { RuntimeTerminalWaitBlockedReason } from './runtime-terminal-action-contracts'
export type {
  ...
  RuntimeTerminalWait
} from './runtime-terminal-action-contracts'
...
export type RuntimeTerminalSummary = {
  ...
  leafId: string
  title: string | null
  /** User-set tab label; absent on older hosts. */

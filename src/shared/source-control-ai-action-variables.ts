...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'MCode’s built-in prompt for this action, including the context MCode knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the MCode workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when MCode has one available.',

...
export const AGENT_SESSION_CONTINUATION_PROMPT_LEAD =
...
export function isAgentSessionContinuationPrompt(text: string): boolean {
  return text.trimStart().startsWith(AGENT_SESSION_CONTINUATION_PROMPT_LEAD)
}

...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'MCode splits each task into an isolated workspace so agents can run in parallel.',
    primaryTileId: 'tile-01',
    relatedTileIds: ['tile-10'],
    docsUrl: 'https://www.mcode.dev/docs/model/worktrees'
  },
  {
    id: 'tasks',
    title: 'Tasks',
    ...
    relatedTileIds: [],
    docsUrl: 'https://www.mcode.dev/docs/review/linear'
  },
  {
    id: 'agents-orchestration',
    title: 'Agents',
    meta: 'Agents · Usage · MCode CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive MCode when it helps.',
    primaryTileId: 'tile-04',
    relatedTileIds: ['tile-11', 'tile-09'],
    docsUrl: 'https://www.mcode.dev/docs/agents/supported'
  },
  {
    id: 'workbench',
    title: 'Workbench',
    meta: 'Terminal · Editor · Browser · Files',
    lede: 'Bring your terminal setup into MCode, then split panes to keep servers, tests, logs, and agents running side by side.',
    primaryTileId: 'tile-02',
    relatedTileIds: ['tile-07', 'tile-05', 'tile-12'],
    docsUrl: 'https://www.mcode.dev/docs/terminal'
  },
  {
    id: 'review',
    title: 'Code Review',
    ...
    relatedTileIds: [],
    docsUrl: 'https://www.mcode.dev/docs/review/annotate-ai-diff'
  }
] as const

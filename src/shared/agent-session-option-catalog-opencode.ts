...
// The `opencode models` probe emits one provider/model id per line — split,
// trim, and drop empties into catalog models with no options (OpenCode's CLI
// has no per-model launch flags to offer).

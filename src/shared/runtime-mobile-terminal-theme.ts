...
import { normalizeTerminalMinimumContrastRatio } from './terminal-minimum-contrast-settings'
...
export function resolveRuntimeMobileTerminalTheme(
  ...
  return {
    ...
    // Why: current-main #10754 — an explicit floor must travel with the palette.

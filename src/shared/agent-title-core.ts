...
// a closed set (the native literal plus the labels MCode synthesizes from Cursor hooks),
...
// MCode's hook-synthesized spinner state, but only once a Cursor-owned title already

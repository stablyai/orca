...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://www.mcode.dev/docs/browser/design-mode'
  },
  {
    id: 'tile-06',
    kind: 'media',
    ...
    caption:
      'Run agents on a remote machine with the same MCode editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
    posterPath: 'tile-06.poster.jpg',
    recordedAtPath: 'tile-06.recorded-at.json',
    owner: 'ssh-workspaces',
    docsUrl: 'https://www.mcode.dev/docs/ssh'
  },
  {
    id: 'tile-07',
    kind: 'media',
    ...
    owner: 'editor',
    docsUrl: 'https://www.mcode.dev/docs/editing/file-explorer'
  },
  {
    id: 'tile-08',
    kind: 'media',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'MCode CLI',
    caption: 'Agents can drive MCode too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
    posterPath: 'tile-09.poster.jpg',
    recordedAtPath: 'tile-09.recorded-at.json',
    owner: 'mcode-cli',
    docsUrl: 'https://www.mcode.dev/docs/cli/overview'
  },
  {
    id: 'tile-10',
    kind: 'media',
    ...
    owner: 'keyboard-ux',
    docsUrl: 'https://www.mcode.dev/docs/model/quick-open'
  },
  {
    id: 'tile-11',
    kind: 'media',
    ...
    docsUrl: 'https://www.mcode.dev/docs/agents/usage-tracking'
  },
  {
    id: 'tile-12',
    kind: 'media',
    ...
    owner: 'file-preview',
    docsUrl: 'https://www.mcode.dev/docs/editing/viewers'
  }
] as const

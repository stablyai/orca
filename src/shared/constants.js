...
function defaultTerminalFontFamily() {
...
export const DEFAULT_STATUS_BAR_ITEMS = ['claude', 'codex', 'ssh', 'sessions'];
...
export function getDefaultSettings(homedir) {
    return {
...
export function getDefaultRepoHookSettings() {
    return {
        mode: 'auto',
...
export function getDefaultPersistedState(homedir) {
    return {
...
export function getDefaultWorkspaceSession() {
    return {
        activeRepoId: null,

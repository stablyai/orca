...
/** Why host only: worktree ids are bare `<repoId>::<path>` (STA-4343), so a cross-host edge could
 *  route an action at the wrong machine; repos on one host can nest freely (#8886). */

...
export function buildResolveConflictsPrompt({
  ...
  return [
    ...
    '- Protect unrelated staged and unstaged changes. Do not run broad cleanup commands like git reset --hard, git checkout ., git restore ., git stash (refs/stash is shared across every worktree of this repository), or abort commands.',

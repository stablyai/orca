export type TaskProvider = 'github' | 'gitlab' | 'linear' | 'jira' | 'hamteamboard'
...
function isTaskProviderAvailable(
  ...
  if (provider === 'hamteamboard') {
    return availability.hamteamboardConnected === true
  }

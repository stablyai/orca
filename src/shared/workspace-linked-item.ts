...
export function areWorkspaceLinkedItemsEqual(
  ...
  return (
    ...
    (a.planeInstanceId ?? null) === (b.planeInstanceId ?? null) &&
...
export function normalizeWorkspaceLinkedItem(value: unknown): WorkspaceLinkedItem | null {
  ...
  return {
    ...
    ...(typeof raw.planeIdentifier === 'string' && raw.planeIdentifier.trim().length > 0
      ...
      : {}),
    ...(typeof raw.planeInstanceId === 'string' && raw.planeInstanceId.trim().length > 0
      ? { planeInstanceId: raw.planeInstanceId.trim() }
      : {}),

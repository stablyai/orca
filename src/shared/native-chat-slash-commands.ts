...
// Why: order mirrors Codex's TUI presentation order rather than alphabetical
// order, so Native Chat suggestions remain familiar.
const CODEX_COMMANDS: readonly SlashCommandSuggestion[] = [
  ...
  { name: 'setup-default-sandbox', description: 'Set up the elevated agent sandbox' },
  {
    ...
    description: 'Let the sandbox read another directory (Windows)'
  },

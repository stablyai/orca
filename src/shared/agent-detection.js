 ...
 */
export function extractLastOscTitle(data) {
    let last = null;
    let m;
...
export function isGeminiTerminalTitle(title) {
    return (title.includes(GEMINI_PERMISSION) ||
...
export function isPiTerminalTitle(title) {
    return title.startsWith(PI_IDLE_PREFIX);
}
function isPiAgentTitle(title) {
    return (isPiTerminalTitle(title) || (containsBrailleSpinner(title) && title.includes(PI_IDLE_PREFIX)));
}
 ...
 */
export function clearWorkingIndicators(title) {
    let cleaned = title;
 ...
 */
export function createAgentStatusTracker(onBecameIdle, onBecameWorking, onAgentExited) {
    let lastStatus = null;
    return {
        handleTitle(title) {
 ...
 */
export function normalizeTerminalTitle(title) {
    if (!title) {
        return title;
    }
 ...
 */
export function isClaudeAgent(title) {
    if (!title) {
        return false;
    }
...
export function getAgentLabel(title) {
    const lower = title.toLowerCase();
    if (isGeminiTerminalTitle(title)) {
        return 'Gemini CLI';
    }
...
export function detectAgentStatusFromTitle(title) {
    if (!title) {
        return null;
    }

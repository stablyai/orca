...
export const ORCHESTRATION_FEDERATION_ATTEMPT_BOUND_WORKER_LEASE_RUNTIME_CAPABILITY =
  'orchestration.federation-attempt-bound-worker-lease.v1' as const
...
export const ORCHESTRATION_FEDERATION_ATTEMPT_BOUND_WORKER_LEASE_PROTOCOL_VERSION = 4 as const
...
export const WORKSPACE_BOOTSTRAP_RECEIPT_V2_RUNTIME_CAPABILITY =
  'workspace-bootstrap-receipt.v2' as const
export const WORKSPACE_BOOTSTRAP_GIT_HOME_RUNTIME_CAPABILITY =
  'workspace-bootstrap.git-home.v1' as const
export const MAESTRO_COMPOSED_BOOTSTRAP_RUNTIME_CAPABILITY = 'maestro.bootstrap.v1' as const
export const ORCHESTRATION_ACTOR_BOUND_SETTLEMENT_RUNTIME_CAPABILITY =
  'orchestration.actor-bound-settlement.v1' as const
export const ORCHESTRATION_NESTED_ACTIVITY_RUNTIME_CAPABILITY =
  'orchestration.nested-activity.v1' as const
export const MAESTRO_RUN_PROGRESS_V2_RUNTIME_CAPABILITY = 'maestro.run-progress.v2' as const
export const MAESTRO_RUN_COMPLETION_RUNTIME_CAPABILITY = 'maestro.run-completion.v1' as const
export const MAESTRO_RUNTIME_CAPABILITY = 'maestro.v1' as const
export const MAESTRO_TERMINAL_LEASE_RUNTIME_CAPABILITY = 'maestro.terminal-lease.v1' as const
export const MAESTRO_BROWSER_SURFACE_RUNTIME_CAPABILITY = 'maestro.browser-surface.v1' as const
export const MAESTRO_RESOURCE_HEALTH_RUNTIME_CAPABILITY = 'maestro.resource-health.v1' as const
export const MAESTRO_WORKSPACE_CANVAS_RUNTIME_CAPABILITY = 'maestro.workspace-canvas.v1' as const
export const BROWSER_TAB_CREATE_FOCUS_RECEIPT_RUNTIME_CAPABILITY =
  'browser.tab-create-focus-receipt.v1' as const
export const MANAGED_CLI_CONTEXT_RUNTIME_CAPABILITY = 'managed-cli-context.v1' as const
export const WORKSPACE_BOOTSTRAP_RECEIPT_RUNTIME_CAPABILITY =
  'workspace-bootstrap-receipt.v1' as const
...
export const TERMINAL_STOP_RECEIPT_RUNTIME_CAPABILITY = 'terminal.stop-receipt.v1' as const
...
export const RUNTIME_CAPABILITIES = [
  ...
  MAESTRO_TERMINAL_LEASE_RUNTIME_CAPABILITY,
  MAESTRO_BROWSER_SURFACE_RUNTIME_CAPABILITY,
  MAESTRO_RESOURCE_HEALTH_RUNTIME_CAPABILITY,
  MAESTRO_WORKSPACE_CANVAS_RUNTIME_CAPABILITY,
  MANAGED_CLI_CONTEXT_RUNTIME_CAPABILITY,
  WORKSPACE_BOOTSTRAP_RECEIPT_RUNTIME_CAPABILITY,
  ...
  BROWSER_TAB_CREATE_FOCUS_RECEIPT_RUNTIME_CAPABILITY,
  ...
  TERMINAL_STOP_RECEIPT_RUNTIME_CAPABILITY,

...
// Why: host-authority resume predates launch-time provider identity publication.
// Mobile may only replace its legacy command path once this stronger contract is advertised.
export const AI_VAULT_HOST_AUTHORITY_RESUME_RUNTIME_CAPABILITY =
  'aiVault.host-authority-resume.v1' as const

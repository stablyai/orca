...
// Why: same skew hazard as kimi — bob joins RESUMABLE_TUI_AGENTS after host-authority.v1, so an
// older host rejects the member with invalid_argument and the pane dies instead of degrading.
export const AGENT_SESSION_BOB_RESUME_RUNTIME_CAPABILITY = 'agent-session.bob-resume.v1' as const

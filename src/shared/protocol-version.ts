...
// Why: older hosts strip terminal.send's queue identity and cannot dedupe an
// ambiguous retry, so mobile only replays input when this capability is present.
export const TERMINAL_INPUT_QUEUE_RUNTIME_CAPABILITY = 'terminal.input-queue.v1' as const

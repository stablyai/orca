...
// Older create/ensure schemas are strict and reject unknown terminal color fields.
export const AGENT_SESSION_COLOR_QUERY_REPLIES_RUNTIME_CAPABILITY =
  'agent-session.color-query-replies.v1' as const

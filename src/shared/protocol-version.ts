...
// Why: older strict agent-session RPC schemas reject terminal palette fields,
// so renderer clients must keep using terminal.create until the host advertises support.
export const AGENT_SESSION_TERMINAL_COLOR_QUERY_RUNTIME_CAPABILITY =
  'agent-session.terminal-color-query.v1' as const

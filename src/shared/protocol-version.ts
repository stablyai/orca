...
// Why: namespace-qualified ref selectors require clients that preserve the
// separate localBranchName metadata; legacy refs-only clients would otherwise
// misclassify a local branch or derive an invalid branch name from `refs/...`.

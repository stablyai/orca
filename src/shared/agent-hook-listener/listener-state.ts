...
export type CursorHookDelivery = {
...
export function createHookListenerState(): HookListenerState {
  return {
    ...
    cursorHookDeliveryByFingerprint: new BoundedMap({ maxEntries: 256 }),
...
export function deletePaneScopedCacheEntry<T>(map: PaneScopedMap<T>, paneKey: string): void {
  map.delete(paneKey)

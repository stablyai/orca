...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote mcode runtime|remote mcode runtime closed the connection|timed out (?:waiting for|while connecting to) the remote mcode runtime/i

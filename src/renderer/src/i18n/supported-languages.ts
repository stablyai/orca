...
export const UI_LANGUAGE_CHOICES: UiLanguageChoice[] = [
  ...
  { value: UI_LANGUAGE_SPANISH_LATAM, labelKey: 'settings.appearance.language.spanishLatam' }
]
...
const UI_LANGUAGE_CHOICE_FALLBACKS: Record<UiLanguage, string> = {
  ...
  [UI_LANGUAGE_SPANISH]: 'Español (España)',
  [UI_LANGUAGE_SPANISH_LATAM]: 'Español (Latinoamérica)'
}

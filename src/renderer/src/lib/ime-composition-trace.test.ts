...
describe('recorded composition traces', () => {
  ...
  it('reports the wrong text when commits are appended instead of replaced', () => {
    // Guards the interpreter itself: VS Code's Korean fixture carries
    // replacePrevCharCnt: 1 on most events, and an appending implementation would
    // score as correct without this.

export const ORCHESTRATION_SETUP_STATE_EVENT = 'mcode:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'mcode.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'mcode.orchestration.setupDismissed'

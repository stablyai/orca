 ...
 * state. Commits replace rather than only append — VS Code's Korean fixture carries
 * `replacePrevCharCnt: 1` on nine of eleven events, and an implementation that appended
 * those instead would produce the right characters in the wrong order.
 */

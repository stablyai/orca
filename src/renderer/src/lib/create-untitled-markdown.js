 ...
 */
export async function createUntitledMarkdownFile(worktreePath, worktreeId) {
    ...
    for (let attempt = 1; attempt <= MAX_ATTEMPTS; attempt += 1) {
        ...
        try {
            ...
            const isEexist = err instanceof Error && (err.message.includes('EEXIST') || err.message.includes('exists'));

...
import { detectAgentStatusFromTitle, clearWorkingIndicators, createAgentStatusTracker, getAgentLabel, isGeminiTerminalTitle, normalizeTerminalTitle } from './agent-status';
...
describe('createAgentStatusTracker', () => {
    ...
    it('end-to-end: extracts OSC title and detects Claude Code transition', () => {
        ...
        const oscTitle = (title) => `\x1b]0;${title}\x07`;
        const chunks = [

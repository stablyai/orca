...
describe('detectLanguage', () => {
  ...
  it('maps Typst files to the typst language id', () => {
    expect(detectLanguage('documents/report.typ')).toBe('typst')
    expect(detectLanguage('C:\\documents\\REPORT.TYP')).toBe('typst')
  })

...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'mcode:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'mcode:emulator-launch-failed'

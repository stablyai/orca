...
import { getActiveUnifiedTabId, isCurrentWorkspaceTab } from './workspace-tab-palette-active-tab'
        ...
        const title = resolveUnifiedTabLabel(
          {
            ...
            conversationName: tab.conversationName ?? terminalTab?.conversationName ?? null,

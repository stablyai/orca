...
describe('markdown document templates', () => {
  ...
  it('discovers markdown files under .mcode/templates and skips unsafe entries', async () => {
    const readDir = stubReadDir({
      '/repo/.mcode/templates': [
        entry('daily-note.md'),
        entry('scratch.txt'),
      ...
      '/repo/.mcode/templates/nested': [entry('meeting.markdown'), entry('brief.mdx')]
    })
    ...
    await expect(
      ...
      {
        id: '.mcode/templates/nested/brief.mdx',
        name: 'Brief',
        filePath: '/repo/.mcode/templates/nested/brief.mdx',
        relativePath: '.mcode/templates/nested/brief.mdx',
        templateRelativePath: 'nested/brief.mdx',
        basename: 'brief.mdx'
      },
      {
        id: '.mcode/templates/daily-note.md',
        name: 'Daily note',
        filePath: '/repo/.mcode/templates/daily-note.md',
        relativePath: '.mcode/templates/daily-note.md',
        templateRelativePath: 'daily-note.md',
        basename: 'daily-note.md'
      },
      {
        id: '.mcode/templates/nested/meeting.markdown',
        name: 'Meeting',
        filePath: '/repo/.mcode/templates/nested/meeting.markdown',
        relativePath: '.mcode/templates/nested/meeting.markdown',
  ...
  it('keeps Windows file paths native while exposing root-relative template paths', async () => {
    stubReadDir({
      'C:\\repo\\.mcode\\templates': [entry('daily.md')]
    })
    ...
    await expect(
      ...
      {
        id: '.mcode/templates/daily.md',
        name: 'Daily',
        filePath: 'C:\\repo\\.mcode\\templates\\daily.md',
        relativePath: '.mcode/templates/daily.md',

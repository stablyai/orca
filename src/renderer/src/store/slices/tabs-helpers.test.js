...
import { findTabAndWorktree, findGroupForTab, ensureGroup, pickNeighbor, updateGroup, patchTab } from './tabs-helpers';
...
describe('findGroupForTab', () => {
    it('finds a group by worktree and groupId', () => {
        const group = { id: 'g1', worktreeId: 'w1', activeTabId: null, tabOrder: [] };
...
describe('updateGroup', () => {
    it('replaces the matching group', () => {
        const g1 = { id: 'g1', worktreeId: 'w1', activeTabId: null, tabOrder: [] };
        const g2 = { id: 'g2', worktreeId: 'w1', activeTabId: null, tabOrder: [] };
        const updated = { ...g1, activeTabId: 't1' };

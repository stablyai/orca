...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  hydratePersistedUI: (ui, source = 'sync') =>
    set((s) => {
      ...
      const statusBarItemsWithCopilot =
        ui._copilotStatusBarDefaultAdded || statusBarItemsWithGrok.includes('copilot')
          ? statusBarItemsWithGrok
          : [...statusBarItemsWithGrok, DEFAULT_ON_COPILOT_STATUS_BAR_ITEM]
      if (
        (!ui._portsStatusBarDefaultAdded ||
          ...
          !ui._copilotStatusBarDefaultAdded) &&
        typeof window !== 'undefined'
      ) {
        window.api.ui
          .set({
            statusBarItems: statusBarItemsWithCopilot,

...
const DEFAULT_ON_FACTORY_STATUS_BAR_ITEM: StatusBarItem = 'factory'
...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  hydratePersistedUI: (ui, source = 'sync') =>
    set((s) => {
      ...
      const statusBarItemsWithFactory =
        ui._factoryStatusBarDefaultAdded || statusBarItemsWithGrok.includes('factory')
          ? statusBarItemsWithGrok
          : [...statusBarItemsWithGrok, DEFAULT_ON_FACTORY_STATUS_BAR_ITEM]
      if (
        (!ui._portsStatusBarDefaultAdded ||
          ...
          !ui._factoryStatusBarDefaultAdded) &&
        typeof window !== 'undefined'
      ) {
        window.api.ui
          .set({
            statusBarItems: statusBarItemsWithFactory,

...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  hydratePersistedUI: (ui, source = 'sync') =>
    set((s) => {
      ...
      const statusBarItemsWithZcode =
        ui._zcodeStatusBarDefaultAdded || statusBarItemsWithGrok.includes('zcode')
          ? statusBarItemsWithGrok
          : [...statusBarItemsWithGrok, DEFAULT_ON_ZCODE_STATUS_BAR_ITEM]
      if (
        (!ui._portsStatusBarDefaultAdded ||
          ...
          !ui._zcodeStatusBarDefaultAdded) &&
        typeof window !== 'undefined'
      ) {
        window.api.ui
          .set({
            statusBarItems: statusBarItemsWithZcode,

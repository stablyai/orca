...
const DEFAULT_ON_LINE_BLAME_STATUS_BAR_ITEM: StatusBarItem = 'line-blame'
...
export const createUISlice: StateCreator<AppState, [], [], UISlice> = (set, get) => ({
  ...
  hydratePersistedUI: (ui, source = 'sync') =>
    set((s) => {
      ...
      const statusBarItemsWithLineBlame =
        ui._lineBlameStatusBarDefaultAdded || statusBarItemsWithGrok.includes('line-blame')
          ? statusBarItemsWithGrok
          : [...statusBarItemsWithGrok, DEFAULT_ON_LINE_BLAME_STATUS_BAR_ITEM]
      if (
        (!ui._portsStatusBarDefaultAdded ||
          ...
          !ui._lineBlameStatusBarDefaultAdded) &&
        typeof window !== 'undefined'
      ) {
        window.api.ui
          .set({
            statusBarItems: statusBarItemsWithLineBlame,

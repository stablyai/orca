...
function createBrowserApi(): NonNullable<Partial<PreloadApi>['browser']> {
  return {
    ...
    getJavaScriptDialog: () => Promise.resolve(null),
    respondJavaScriptDialog: () => Promise.resolve(false),
    onJavaScriptDialogOpened: () => noopUnsubscribe,
    onJavaScriptDialogClosed: () => noopUnsubscribe,

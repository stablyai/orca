...
export function resolveZoomTarget(args) {
    ...
    const terminalInputFocused = typeof activeElement === 'object' &&
        activeElement !== null &&
        'classList' in activeElement &&
        typeof activeElement.classList?.contains ===
            'function' &&
        activeElement.classList.contains('xterm-helper-textarea');
    const editorFocused = typeof activeElement === 'object' &&
        activeElement !== null &&
        'closest' in activeElement &&
        typeof activeElement.closest === 'function' &&
        Boolean(activeElement.closest('.monaco-editor, .diff-editor, .markdown-preview, .rich-markdown-editor, .rich-markdown-editor-shell'));

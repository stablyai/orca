...
describe('useComposerState host-context boundaries', () => {
  ...
  it('prepares linked quick-create drafts for the selected default agent', () => {
    ...
    expect(quickSubmit).toContain('resolveQuickCreatePrompt({')
    expect(quickSubmit).toContain('typedPrompt: agentPrompt')
    expect(quickSubmit).toContain('linkedWorkItem: promptLinkedWorkItem')

...
// Why: the sheet samples freshness from useNow's shared clock; route it through the
// per-test Date.now mock so static renders see the test's controlled time.

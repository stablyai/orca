            ...
            return (
              ...
              >
                <div
                  ...
                  tabIndex={0}
                  className={cn(
                    'group flex h-7 w-full items-center gap-1.5 pl-3 pr-1.5 text-left transition-all cursor-pointer',
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          variant="ghost"
                          size="icon-xs"
                          className="mr-0.5 size-5 shrink-0 rounded-md text-muted-foreground hover:bg-accent/70 hover:text-foreground transition-opacity"

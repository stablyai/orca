...
describe('computeSmartScore', () => {
    ...
    it('prioritizes recent activity over a merely linked worktree', () => {
        ...
        expect(computeSmartScore(active, null, repoMap, null)).toBeGreaterThan(computeSmartScore(linked, null, repoMap, prCache));
    });
    it('keeps recent activity relevant beyond a one-hour window', () => {
        ...
        expect(computeSmartScore(recent, null, repoMap, null)).toBeGreaterThan(computeSmartScore(stale, null, repoMap, null));
    });
    it('rewards live terminals even without detected agent status', () => {
        ...
        expect(computeSmartScore(withLiveTerminal, tabsByWorktree, repoMap, null)).toBeGreaterThan(computeSmartScore(withoutLiveTerminal, tabsByWorktree, repoMap, null));
    });
    it('uses the current branch PR cache instead of persisted linkedPR metadata', () => {
        ...
        expect(computeSmartScore(livePR, null, repoMap, prCache)).toBeGreaterThan(computeSmartScore(staleLinked, null, repoMap, prCache));
    });
    it('falls back to linkedPR when the current branch cache entry is still cold', () => {
        ...
        expect(computeSmartScore(linked, null, repoMap, {})).toBeGreaterThan(computeSmartScore(plain, null, repoMap, {}));
    });
});
describe('buildWorktreeComparator', () => {
    ...
    it('can freeze the active worktree recent signals without blocking background reordering', () => {
        ...
        worktrees.sort(buildWorktreeComparator('smart', tabsByWorktree, repoMap, null, NOW, smartSortOverrides));

...
describe('WorktreeCardDetailsHover', () => {
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://github.com/acme/mcode/pull/456',
          status: 'success',
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        issue={{
          ...
          state: 'open',
          url: 'https://github.com/acme/mcode/issues/5518',
          labels: []
        }}
        linearIssue={null}
        review={null}
  ...
  it('puts unlink behind the first PR actions menu and keeps GitHub last', () => {
    ...
    const openInMCodeIndex = markup.indexOf('aria-label="Open in MCode"')
    ...
    expect(moreActionsIndex).toBeLessThan(openInMCodeIndex)
    expect(openInMCodeIndex).toBeLessThan(viewOnGitHubIndex)
  ...
  it('puts issue copy menu before edit and open actions and keeps GitHub last', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenGitHubIssueInMCode={vi.fn()}
      >
    ...
    expect(editIssueIndex).toBeLessThan(openInMCodeIndex)
    expect(openInMCodeIndex).toBeLessThan(viewOnGitHubIndex)
  })
    ...
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        review={{
          ...
          state: 'open',
          url: 'https://gitlab.com/acme/mcode/-/merge_requests/77',
          status: 'success'
        }}
        comment={null}
        onEditIssue={vi.fn()}
  ...
  it('displays Linear issue details with link', () => {
    const markup = renderToStaticMarkup(
      <WorktreeCardDetailsHover
        ...
        onEditIssue={vi.fn()}
        onEditComment={vi.fn()}
        onOpenLinearIssueInMCode={vi.fn()}
      >
        <span>ENG-123</span>
      </WorktreeCardDetailsHover>
    )

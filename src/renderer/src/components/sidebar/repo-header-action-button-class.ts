export const REPO_HEADER_ACTION_REVEAL_CLASS =
  'min-w-0 max-w-0 -ml-1.5 overflow-hidden opacity-0 focus:ml-0 focus:max-w-5 focus:opacity-100 group-hover:ml-0 group-hover:max-w-5 group-hover:opacity-100 [@media(hover:none)]:ml-0 [@media(hover:none)]:max-w-5 [@media(hover:none)]:opacity-100'

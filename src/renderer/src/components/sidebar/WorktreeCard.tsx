...
const WorktreeCard = React.memo(function WorktreeCard({
  ...
  const cardBody = (
    <div
      className={cn(
        'group relative flex items-start gap-0.5 pl-0 pr-1.5 pt-1.25 pb-1.5 cursor-pointer transition-[background-color,border-color,opacity,box-shadow] duration-200 outline-none select-none',

...
export default function CacheTimer({ worktreeId }) {
    ...
    return (_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs("div", { className: cn('inline-flex items-center gap-1 text-[10px] font-mono tabular-nums select-none leading-none', expired ? 'text-red-400' : warning ? 'text-yellow-400' : 'text-muted-foreground'), children: [_jsx(Timer, { className: "size-2.5" }), _jsx("span", { children: expired ? 'expired' : label })] }) }), _jsx(TooltipContent, { side: "right", sideOffset: 8, children: _jsx("span", { children: tooltipText }) })] }));
}

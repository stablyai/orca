...
const CLI_AGENT_COMMANDS = [
  'mcode worktree create --name auth-pr-1',
  'mcode worktree create --name auth-pr-2',
  'mcode orchestration dispatch --task pr1 --to w1',
  'mcode orchestration dispatch --task pr2 --to w2'
]

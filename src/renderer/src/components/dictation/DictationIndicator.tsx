...
export function DictationIndicator() {
  ...
  return (
    <div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-lg bg-foreground/90 px-3 py-1.5 text-background-opaque text-sm shadow-lg">

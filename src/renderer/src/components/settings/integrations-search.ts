...
export const getIntegrationsPaneSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      'auto.components.settings.integrations.search.jiraCloudServerCredentials',
    ...
    keywords: [
      ...
      ...translateSearchKeyword(
        'auto.components.settings.integrations.search.jiraServerKeyword',
        'server'
      ),
      ...translateSearchKeyword(
        'auto.components.settings.integrations.search.jiraDataCenterKeyword',
        'data center'
      ),
      ...translateSearchKeyword(

  ...
  return (
    <section key="workspace" className="space-y-4">
      ...
      <div id="general-skip-delete-artifact-confirm" className="scroll-mt-6">
        <SearchableSetting
          title={translate(
            'auto.components.settings.GeneralWorkspaceSettingsSection.askBeforeDeletingArtifacts',
            'Ask Before Deleting Artifacts'
          )}
          description={translate(
            'auto.components.settings.GeneralWorkspaceSettingsSection.askBeforeDeletingArtifactsSearch',
        ...
        >
          <SettingsSwitchRow
            ...
            description={translate(
              'auto.components.settings.GeneralWorkspaceSettingsSection.askBeforeDeletingArtifactsDescription',

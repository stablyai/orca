        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'When a new worktree is created, each path listed here is clone-copied when the filesystem supports it (APFS clone-copy on macOS; reflink on Linux for btrfs, XFS and OpenZFS block cloning), otherwise symlinked from the primary checkout.'
            )}
          </p>
        </div>

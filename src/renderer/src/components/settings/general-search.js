export const GENERAL_WORKSPACE_SEARCH_ENTRIES = [
    {
...
export const GENERAL_EDITOR_SEARCH_ENTRIES = [
    {
...
export const GENERAL_CLI_SEARCH_ENTRIES = [
    {
        title: 'Shell command',
...
export const GENERAL_UPDATE_SEARCH_ENTRIES = [
    {
...
export const GENERAL_CACHE_TIMER_SEARCH_ENTRIES = [
    {
...
export const GENERAL_CODEX_ACCOUNTS_SEARCH_ENTRIES = [
    {
...
export const GENERAL_AGENT_SEARCH_ENTRIES = [
    {
        title: 'Default Agent',
...
export const GENERAL_PANE_SEARCH_ENTRIES = [

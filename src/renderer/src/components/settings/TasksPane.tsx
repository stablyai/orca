...
import { CodeHostSetupSteps, JiraSetupSteps, MantisBTSetupSteps } from './TaskSourceSimpleSetup'
...
import {
  ...
  MANTISBT_INTEGRATION_SECTION_ID
...
> = {
  ...
  mantisBT: {
    get label() {
      return translate('auto.components.settings.TasksPane.mantisBTLabel', 'MantisBT')
    },
    get description() {
      return translate(
              ...
              >
                {provider === 'linear' ? (
                  ...
                  <MantisBTSetupSteps
                    ...
                    visible={visible}
                    canHide={canHide}
                    onToggleVisible={() => toggleProvider('mantisBT')}
                    onConnected={() => void checkMantisBTConnection()}
                    onOpenIntegrations={() => openIntegrations(MANTISBT_INTEGRATION_SECTION_ID)}
                  />
                ) : (
                  <CodeHostSetupSteps

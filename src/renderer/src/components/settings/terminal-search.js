export const TERMINAL_TYPOGRAPHY_SEARCH_ENTRIES = [
    {
        title: 'Font Size',
...
export const TERMINAL_CURSOR_SEARCH_ENTRIES = [
    {
        title: 'Cursor Shape',
...
export const TERMINAL_PANE_STYLE_SEARCH_ENTRIES = [
    {
...
export const TERMINAL_DARK_THEME_SEARCH_ENTRIES = [
    {
        title: 'Dark Theme',
...
export const TERMINAL_LIGHT_THEME_SEARCH_ENTRIES = [
    {
...
export const TERMINAL_ADVANCED_SEARCH_ENTRIES = [
    {
...
export const TERMINAL_MAC_OPTION_SEARCH_ENTRIES = [
    {
        title: 'Option as Alt',
...
export const TERMINAL_SETUP_SCRIPT_SEARCH_ENTRIES = [
    {
        title: 'Setup Script Location',
        description: "Where the repository setup script runs when a new workspace is created: a vertical split (default), a horizontal split, or a background tab titled 'Setup'.",
        keywords: [
            'setup',
            'script',
            'workspace',

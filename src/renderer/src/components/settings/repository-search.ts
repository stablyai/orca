  ...
  return [
    {
      ...
      keywords: [
        repo.displayName,
        repo.path,
        translate('auto.components.settings.repository.search.92af66c7ce', 'project name'),
        translate('auto.components.settings.repository.search.cd73b976d7', 'repository name')
      ]
    },
    {
      ...
      : [
          {
            ...
            keywords: [
              repo.displayName,
              translate('auto.components.settings.repository.search.f41cef5083', 'base ref'),
              translate('auto.components.settings.repository.search.9811f3d152', 'branch')
            ]
          },
          {
            title: translate(
        ...
        ]),
    {
      ...
      keywords: [
        repo.displayName,
        translate('auto.components.settings.repository.search.3067595d82', 'delete'),
        translate('auto.components.settings.repository.search.6469de5368', 'project'),
        translate('auto.components.settings.repository.search.cc876ca5f2', 'repository')
      ]
    },
    ...(isFolder
      ? []

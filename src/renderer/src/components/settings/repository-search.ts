  ...
  return [
      ...
      : [
          {
            ...
            keywords: [
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.9811f3d152',
                'branch'
              )
            ]
          },
    ...
    ...(isFolder
      ...
      : [
          {
            title: translate(
              'auto.components.settings.repository.search.eec3995dc6',
              'Git AI Author'
            ),
            description: translate(
            ...
            keywords: [
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.cfad7ce5f3',
                'ai'
              ),
              ...translateSearchKeyword(
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.8068d8d0f1',
                'pr'
              ),
              ...translateSearchKeyword(
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.fa3131f223',
                'model'
              ),
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.fff8834983',
                'prompt'
              )
            ]
          },
          {
            ...
            keywords: [
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.3c180a251c',
                'link'
              ),
              ...translateSearchKeyword(
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.0a3a582794',
                'env'
              ),
              ...translateSearchKeyword(
          ...
          {
            title: translate(
              'auto.components.settings.repository.search.31bd0a2420',
              'MCP Configs'
            ),
            description: translate(
            ...
            keywords: [
              repo.displayName,
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.343f0a508c',
                'mcp'
              ),
              ...translateSearchKeyword(
          ...
          {
            title: translate(
              'auto.components.settings.repository.search.b79df26937',
              'Setup Script'
            ),
            description: translate(
            ...
            keywords: [
              repo.displayName,
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.8655e3387b',
                'hooks'
              ),
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.5590388dfa',
                'setup'
              ),
              ...translateSearchKeyword(
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.bf460fded8',
                'yaml'
              )
            ]
          },
          {
            title: translate(
              'auto.components.settings.repository.search.bce0ca23c6',
              'Archive Script'
            ),
            description: translate(
          ...
          },
          {
            ...
            keywords: [
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.0432d2fb7c',
                'local'
              ),
              ...translateSearchKeyword(
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.1d90a6cfbb',
                'both'
              ),
              ...translateSearchKeyword(
          ...
          },
          {
            ...
            keywords: [
              ...
              ...translateSearchKeyword(
                'auto.components.settings.repository.search.80c490b012',
                'ask'
              ),
              ...translateSearchKeyword(

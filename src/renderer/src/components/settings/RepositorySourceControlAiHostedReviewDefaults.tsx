...
export function RepositorySourceControlAiHostedReviewDefaults({
  ...
  return (
    <div className="space-y-2">
      <Label className="text-xs font-medium">{translate("auto.components.settings.RepositorySourceControlAiHostedReviewDefaults.aa6ee4b7d6", "Hosted-review creation defaults")}</Label>
      <div className="space-y-2">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="inherit">{translate("auto.components.settings.RepositorySourceControlAiHostedReviewDefaults.ffc3b26b26", "Use global")}</SelectItem>
                  <SelectItem value="on">{translate("auto.components.settings.RepositorySourceControlAiHostedReviewDefaults.777443bf89", "On")}</SelectItem>
                  <SelectItem value="off">{translate("auto.components.settings.RepositorySourceControlAiHostedReviewDefaults.053ccfbf52", "Off")}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          )

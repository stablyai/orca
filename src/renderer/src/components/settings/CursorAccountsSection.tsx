...
export function CursorAccountsSection(): React.JSX.Element {
  ...
  const usageWindow = cursorUsage?.monthly ?? cursorUsage?.weekly ?? cursorUsage?.session ?? null
      ...
      {usageWindow ? (
        <SearchableSetting
          ...
          description={translate(
            ...
            'Same plan usage % as the Cursor dashboard.'
          )}
          keywords={['cursor', 'usage', 'subscription', 'plan']}
        >

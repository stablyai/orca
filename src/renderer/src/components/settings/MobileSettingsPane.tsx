...
const MCODE_IOS_APP_STORE_URL = 'https://apps.apple.com/app/mcode-ide/id6766130217'
const MCODE_ANDROID_APK_URL =
  'https://github.com/mcode-ide/mcode/releases/download/mobile-android-v0.0.43/app-release.apk'
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install MCode Mobile from the'
            )}{' '}
            <button
              type="button"
              onClick={() => void window.api.shell.openUrl(MCODE_IOS_APP_STORE_URL)}
            ...
            <button
              ...
              onClick={() => void window.api.shell.openUrl(MCODE_ANDROID_APK_URL)}
              className="cursor-pointer underline underline-offset-2 hover:text-foreground"
            >
              {translate(
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the MCode Mobile shortcut in the sidebar.'
          )}

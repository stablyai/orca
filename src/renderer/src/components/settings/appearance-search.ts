...
export const getLanguageEntries = createLocalizedCatalog((): SettingsSearchEntry[] => [
  {
    ...
    keywords: [
      ...
      translate('settings.appearance.language.chinese', '中文（简体）'),
      translate('settings.appearance.language.korean', '한국어'),
      translate('settings.appearance.language.japanese', '日本語'),

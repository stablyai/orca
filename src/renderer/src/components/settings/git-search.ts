...
export const getGitPaneSearchEntries = createLocalizedCatalog(() => [
  ...
  {
    title: translate(
      'auto.components.settings.git.search.f040e57336',
      'Source Control Group Order'
    ),
    description: translate(
      'auto.components.settings.git.search.990fbb3e30',
      'Choose how uncommitted file groups are ordered.'
    ),
    keywords: [
      ...translateSearchKeyword('auto.components.settings.git.search.5e8cef3d84', 'source control'),
      ...translateSearchKeyword('auto.components.settings.git.search.7dcfc4f47e', 'staged'),
      ...translateSearchKeyword('auto.components.settings.git.search.97beaf0945', 'changes'),
      ...translateSearchKeyword('auto.components.settings.git.search.dab1e4f6ac', 'untracked'),
      ...translateSearchKeyword('auto.components.settings.git.search.bef787694f', 'group order'),
      ...translateSearchKeyword('auto.components.settings.git.search.9fb3f26fe3', 'commit')
    ]
  },
  {

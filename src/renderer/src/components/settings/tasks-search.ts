...
export const getTasksPaneSearchKeywords = createLocalizedCatalog(() => [
  ...
  ...translateSearchKeyword('auto.components.settings.tasks.search.shortcut', 'shortcut'),
  ...translateSearchKeyword('auto.components.settings.tasks.search.story', 'story'),

...
export const getTasksPaneSearchKeywords = createLocalizedCatalog(() => [
  ...
  ...translateSearchKeyword('auto.components.settings.tasks.search.businessmap', 'businessmap'),
  ...translateSearchKeyword('auto.components.settings.tasks.search.kanbanize', 'kanbanize'),

...
export function JiraIntegrationCard(): React.JSX.Element {
  ...
  const credentialCopy = hasRemoteProviderRuntime(settings)
    ? translate(
        'auto.components.settings.task.tracker.integration.cards.jiraCloudServerRemoteCredentialCopy',
    ...
    : translate(
        'auto.components.settings.task.tracker.integration.cards.jiraCloudServerLocalCredentialCopy',
      ...
      description={
        connected
          ...
          : checking
            ...
            : translate(
                'auto.components.settings.task.tracker.integration.cards.jiraCloudServerIssueDescription',
        ...
        {connected && sites.length > 0 ? (
          <div className="space-y-2">
            ...
            <p className="text-[11px] text-muted-foreground/70">
              {translate(
                'auto.components.settings.task.tracker.integration.cards.connectedJiraCredentialStorage',

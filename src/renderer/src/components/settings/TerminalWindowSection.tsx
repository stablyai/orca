...
const COLOR_OVERRIDE_GROUPS: {
...
}[] = [
  {
    ...
    keys: [
      {
        key: 'foreground',
        label: translate('auto.components.settings.TerminalWindowSection.79f6bfb76e', 'Foreground'),
      ...
      {
        key: 'background',
        label: translate('auto.components.settings.TerminalWindowSection.cc1b2ffeb2', 'Background'),
        description: translate(
      ...
      {
        key: 'cursor',
        label: translate('auto.components.settings.TerminalWindowSection.c9e1fdf42f', 'Cursor'),
        description: translate(
  ...
  },
  {
    ...
    keys: [
      {
        key: 'black',
        label: translate('auto.components.settings.TerminalWindowSection.adfdee23cb', 'Black'),
        description: translate(
      ...
      {
        key: 'red',
        label: translate('auto.components.settings.TerminalWindowSection.3a78f30b50', 'Red'),
        description: translate(
      ...
      {
        key: 'green',
        label: translate('auto.components.settings.TerminalWindowSection.8f2092b315', 'Green'),
        description: translate(
      ...
      {
        key: 'yellow',
        label: translate('auto.components.settings.TerminalWindowSection.bb516de873', 'Yellow'),
        description: translate(
      ...
      {
        key: 'blue',
        label: translate('auto.components.settings.TerminalWindowSection.292a4c7316', 'Blue'),
        description: translate(
      ...
      {
        key: 'magenta',
        label: translate('auto.components.settings.TerminalWindowSection.d5e92fcd94', 'Magenta'),
        description: translate(
      ...
      {
        key: 'cyan',
        label: translate('auto.components.settings.TerminalWindowSection.fb8bb4eb1f', 'Cyan'),
        description: translate(
      ...
      {
        key: 'white',
        label: translate('auto.components.settings.TerminalWindowSection.0cb4459fb8', 'White'),
        description: translate(
  ...
  },
  {
    ...
    keys: [
      ...
      {
        key: 'brightRed',
        label: translate('auto.components.settings.TerminalWindowSection.32b1b6acd7', 'Bright Red'),
        description: translate(

...
vi.mock('./TaskSourceSimpleSetup', () => ({
  ...
  VoloSetupSteps: () => <div data-testid="volo-setup">Volo setup</div>
}))
...
vi.mock('@/store', () => ({
  useAppStore: (
    ...
    selector({
      ...
      checkVoloConnection: mocks.checkVoloConnection,
      settingsSearchQuery: ''
    })
}))
...
describe('TasksPane', () => {
  beforeEach(() => {
    ...
    mocks.readiness = {
      ...
      volo: { connected: false, checking: false, visible: false }
    }
  })

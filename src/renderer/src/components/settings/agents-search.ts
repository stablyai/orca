...
function buildAgentSettingsKeywords(): string[] {
  const keywords = searchKeywords([
    ...
    { key: 'auto.components.settings.agents.search.profiles', fallback: 'profiles' },
    { key: 'auto.components.settings.agents.search.args', fallback: 'args' },
    { key: 'auto.components.settings.agents.search.env', fallback: 'env' },

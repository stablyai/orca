...
// Provider usage segments (Claude, Codex, Gemini, …) split out so the toggle
// catalog stays under the max-lines ceiling.
export function getUsageStatusBarToggles(): readonly StatusBarToggle[] {
  return [
    {
      id: 'claude',

...
export function GitPane({
  ...
  const visibleSections = [
    ...
    matchesSettingsSearch(searchQuery, {
      ...
      keywords: [
        translate('auto.components.settings.GitPane.d9c154f20d', 'source control'),
        translate('auto.components.settings.GitPane.46d15bb9b2', 'staged'),
        translate('auto.components.settings.GitPane.6c3e226b4d', 'changes'),
        translate('auto.components.settings.GitPane.d8c035a72a', 'untracked'),
        translate('auto.components.settings.GitPane.a3f253d8ef', 'group order'),
        translate('auto.components.settings.GitPane.35aa085a33', 'commit')
      ]
    }) ? (

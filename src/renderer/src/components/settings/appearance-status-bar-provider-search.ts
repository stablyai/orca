...
export function getProviderStatusBarToggleSearchEntries(): readonly StatusBarToggleSearchEntry[] {
  return [
    {
      id: 'claude',
    ...
    {
      id: 'zai',
      title: translate('auto.components.settings.appearance.search.zaiTitle', 'Z.ai GLM Usage'),
      description: translate(
        'auto.components.settings.appearance.search.zaiDescription',
        'Show Z.ai GLM usage in the status bar.'
      ),
      keywords: [
        ...translateSearchKeyword(
          'auto.components.settings.appearance.search.statusBar',
          'status bar'
        ),
        ...
        ...translateSearchKeyword('auto.components.settings.appearance.search.usage', 'usage'),
        ...translateSearchKeyword('auto.components.settings.appearance.search.apiKey', 'api key'),
        ...translateSearchKeyword(
          'auto.components.settings.appearance.search.rateLimit',
          'rate limit'
        )
      ],
      toggleDescription: translate(
        'settings.appearance.statusBar.zaiToggleDescription',
        'Show Z.ai GLM usage for the active workspace.'
      )
    },

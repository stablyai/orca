...
import { installPreviewTerminalCopyHandlers } from './preview-terminal-copy-handlers'
...
export function AgentTerminalPreview({
  ...
  useEffect(() => {
    ...
    let disposeTerminalCopyHandlers: (() => void) | null = null
    ...
    const replayConnection = (
      ...
      if (!terminal) {
        ...
        disposeTerminalCopyHandlers = installPreviewTerminalCopyHandlers(terminal).dispose
        installInputRouting()
    ...
    const setup = async (replaceExisting = false): Promise<void> => {
      ...
      if (!snap) {
        ...
        disposeTerminalCopyHandlers?.()
        disposeTerminalCopyHandlers = null
        terminal?.dispose()
        terminal = null

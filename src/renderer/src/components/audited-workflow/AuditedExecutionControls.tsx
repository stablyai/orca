...
export function AuditedExecutionControls({ task }: Props): React.JSX.Element | null {
  ...
  //
  // awaiting_human_approval, committing, and committed belong to the Phase 8
  // commit lane, which AuditedCommitPanel owns. This component renders nothing
  // for them rather than duplicating (or contradicting) that panel's affordances.
  if (

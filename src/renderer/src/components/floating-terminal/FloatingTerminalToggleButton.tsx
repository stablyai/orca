      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            aria-label={open ? translate("auto.components.floating.terminal.FloatingTerminalToggleButton.5785dd9148", "Minimize floating workspace") : translate("auto.components.floating.terminal.FloatingTerminalToggleButton.3b04b065b5", "Show floating workspace")}
            aria-pressed={open}

              ...
              <div className="relative flex items-center justify-end">
                {!isActive ? (
                  ...
                  <button
                    ...
                    className={`pointer-events-none inline-flex items-center gap-1.5 rounded-md bg-foreground px-2.5 py-1 text-[11px] font-semibold text-[var(--background-opaque,var(--background))] transition-[transform,filter] duration-150 ${

...
// Mac-style terminal traffic-light dots — the signature of an MCode terminal pane.
...
// Use MCode's browser: a browser pane with a cursor grabbing one highlighted

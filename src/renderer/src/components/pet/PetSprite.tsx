...
export function usePetAnimationName(
  dragging: boolean,
...
export const PET_BOB_KEYFRAMES_CSS =
  '@keyframes pet-bob { 0%,100% { transform: translateY(0); } 50% { transform: translateY(-4px); } }'

/** The pet artwork alone — no positioning, dragging, or bob. Callers own the box it sits in. */
export function PetSprite({
  ...
  if (detected) {
    return <DetectedSpriteFrame detected={detected} animate={animate} maxSize={size} />
  }

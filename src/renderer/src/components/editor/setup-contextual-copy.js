...
export function setupContextualCopy({ editorInstance, monaco, filePath, copyShortcutLabel, setCopyToast, propsRef, copyToastTimeoutRef }) {
    ...
    const isContextualCopyShortcut = (event) => {

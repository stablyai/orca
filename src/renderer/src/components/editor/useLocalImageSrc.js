 ...
 */
export function onImageCacheInvalidated(listener) {
 ...
 */
export function useLocalImageSrc(rawSrc, filePath, connectionId) {
 ...
 * available.
 */
export async function loadLocalImageSrc(rawSrc, filePath, connectionId) {

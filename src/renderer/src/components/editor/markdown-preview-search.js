export function isMarkdownPreviewFindShortcut(event, isMac) {
...
export function clearMarkdownPreviewSearchHighlights(root) {
    const highlights = root.querySelectorAll('[data-markdown-preview-search-match]');
...
export function applyMarkdownPreviewSearchHighlights(root, query) {
...
export function setActiveMarkdownPreviewSearchMatch(matches, activeIndex) {

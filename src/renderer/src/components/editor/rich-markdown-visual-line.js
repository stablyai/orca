 ...
 */
export function getVisualLineRange(view, cursorPos, paraStart, paraEnd) {
    ...
    const lineTo = nextResult && nextResult.pos > lineFrom && nextResult.pos <= paraEnd ? nextResult.pos : paraEnd;
 ...
 */
export function cutVisualLine(view, event, lineRange) {

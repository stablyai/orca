...
describe('rich markdown details keyboard behavior', () => {
  it.each([
    [
      ...
      '<details class="mcode-details">\n<summary>Toggle</summary>\n\n\n\n</details>'
    ],
    [
      'heading toggle',
      '<details data-mcode-toggle="heading-1"><summary>Toggle</summary><p></p></details>',
      '<details class="mcode-details" data-mcode-toggle="heading-1">\n<summary>Toggle</summary>\n\n\n\n</details>'
    ]

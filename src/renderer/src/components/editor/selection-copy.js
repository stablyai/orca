export function formatCopiedSelectionWithContext({ relativePath, language, selection, selectedText }) {
...
export function getContextualCopyLineRange(selection) {
    return {
        startLine: selection.startLineNumber,
        endLine: getInclusiveEndLine(selection)
    };
}
export function getInclusiveEndLine(selection) {

 ...
 */
export default function MermaidBlock({ content, isDark, htmlLabels = true }) {
    ...
    if (error) {
        return (_jsxs("div", { className: "mermaid-block", children: [_jsxs("div", { className: "mermaid-error", children: ["Diagram error: ", error] }), _jsx("pre", { children: _jsx("code", { children: content }) })] }));
    }
    return _jsx("div", { className: "mermaid-block", ref: containerRef });
}

...
const emptyHintByMode: Record<SmartNameMode, string> = {
  ...
  // Why: GitLab tab uses Open / Merged / Closed / All chips rather
  // than free-text search; the empty hint nudges users toward those.
  gitlab: 'Pick a state filter to browse GitLab MRs, or paste a URL.',

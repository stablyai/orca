...
function revealLabel(): string {
  if (isMac) return translate('auto.components.tab.bar.EditorFileTabContextMenu.91176b5625', 'Reveal in Finder')
  if (isLinux) return translate('auto.components.tab.bar.EditorFileTabContextMenu.fe23001e60', 'Open Containing Folder')
  return translate('auto.components.tab.bar.EditorFileTabContextMenu.3da91e073d', 'Reveal in File Explorer')
}

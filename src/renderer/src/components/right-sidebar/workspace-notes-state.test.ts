...
import { selectActiveWorkspaceNote, type WorkspaceNotesState } from './workspace-notes-state'
...
function state(overrides: Partial<WorkspaceNotesState> = {}): WorkspaceNotesState {
  return {

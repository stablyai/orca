...
describe('filterAiVaultSessions', () => {
  ...
  it('matches workspace sessions under prior renamed worktree paths', () => {
    const sessions: AiVaultSession[] = [
      {
        ...baseSession,
        id: 'claude:old-path',
        cwd: '/Users/ada/workspaces/mcode/bream/src'
      },
      {
        ...baseSession,
    ...
    expect(
      filterAiVaultSessions(sessions, {
        ...
        sort: 'updated',
        activeWorktreePaths: [
          '/Users/ada/workspaces/mcode/fix-agent-history',
          '/Users/ada/workspaces/mcode/bream'
        ],
        hideEmptySessions: true
      }).map((session) => session.id)
  ...
  it('filters project scope by the resolved active project key', () => {
    ...
    const sessionProjectById = new Map([
      [projectSession.id, { kind: 'repo' as const, key: 'project:mcode', label: 'MCode' }],
    ...
    expect(
      filterAiVaultSessions([projectSession, otherSession], {
        ...
        sort: 'updated',
        activeWorktreePaths: [],
        activeProjectKey: 'project:mcode',
        sessionProjectById,
        hideEmptySessions: true
      }).map((session) => session.id)
  ...
  it('matches repo: queries against resolved project labels before folder fallback', () => {
    const sessionProjectById = new Map([
      [baseSession.id, { kind: 'repo' as const, key: 'project:mcode', label: 'Canonical MCode' }]
    ])
    const projectLabelByKey = new Map([['project:mcode', 'Canonical MCode']])
...
describe('deriveAiVaultWorkspaceScopePaths', () => {
  it('includes current and same-repo prior filesystem paths', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/workspaces/mcode/fix-agent-history',
        repoId: 'repo1',
        path: '/Users/ada/workspaces/mcode/fix-agent-history',
        priorWorktreeIds: ['repo1::/Users/ada/workspaces/mcode/bream']
      })
    ).toEqual(['/Users/ada/workspaces/mcode/fix-agent-history', '/Users/ada/workspaces/mcode/bream'])
  })

  it('strips folder-workspace instance suffixes from prior ids', () => {
    expect(
      deriveAiVaultWorkspaceScopePaths({
        id: 'repo1::/Users/ada/folders/mcode',
        repoId: 'repo1',
        path: '/Users/ada/folders/mcode',
        priorWorktreeIds: [
          'repo1::/Users/ada/folders/old-mcode::workspace:123e4567-e89b-12d3-a456-426614174000'
        ]
      })
    ).toEqual(['/Users/ada/folders/mcode', '/Users/ada/folders/old-mcode'])
  })
      ...
      deriveAiVaultWorkspaceScopePaths(
        {
          ...
          path: '/Users/ada/workspaces/mcode/fix-agent-history',
          priorWorktreeIds: [
            'repo1::/Users/ada/workspaces/mcode/bream',
            'repo1::/Users/ada/workspaces/mcode/unclaimed-old-path'
          ]
        },
        [
          {
          ...
          {
            id: 'repo1::/Users/ada/workspaces/mcode/bream',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/mcode/bream'
          }
        ]
      )
    ).toEqual([
      '/Users/ada/workspaces/mcode/fix-agent-history',
      '/Users/ada/workspaces/mcode/unclaimed-old-path'
    ])
  })
    ...
    expect(
      deriveAiVaultWorkspaceScopePaths(
        ...
        [
          ...
          {
            id: 'repo2::/Users/ada/workspaces/mcode/bream',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/mcode/bream'
          }
        ]
...
describe('deriveAiVaultScopeSessionPaths', () => {
    ...
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          ...
          {
            id: 'repo1::/Users/ada/workspaces/mcode/sibling',
            repoId: 'repo1',
            path: '/Users/ada/workspaces/mcode/sibling'
          },
          {
      ...
      '/Users/ada/workspaces/mcode/fix-agent-history',
      '/Users/ada/workspaces/mcode/sibling'
    ])
  })
  ...
  it('adds active project setup paths across repos', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        {
          id: 'repo1::/Users/ada/workspaces/mcode/app',
          repoId: 'repo1',
          path: '/Users/ada/workspaces/mcode/app',
          priorWorktreeIds: []
        },
        [
          {
          ...
          {
            id: 'repo2::/Users/ada/workspaces/mcode/docs',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/mcode/docs'
          }
        ],
        {
          activeProjectKey: 'project:mcode',
    ...
    ).toEqual(['/Users/ada/workspaces/mcode/app', '/Users/ada/workspaces/mcode/docs'])
  })
  ...
  it('keeps live worktree paths when another setup shares the repo id', () => {
    expect(
      deriveAiVaultScopeSessionPaths(
        ...
        [
          {
            id: 'repo2::/Users/ada/workspaces/mcode/docs-worktree',
            repoId: 'repo2',
            path: '/Users/ada/workspaces/mcode/docs-worktree'
          }
        ],
        {
          activeProjectKey: 'project:mcode',
      ...
      '/Users/ada/workspaces/mcode/app',
      '/Users/ada/workspaces/mcode/docs-worktree',
      '/Users/ada/workspaces/mcode/docs'
    ])
  })
})
  ...
  it('groups sibling worktree sessions by project label when resolved', () => {
    ...
    const sessionProjectById = new Map(
      sessions.map((session) => [
        session.id,
        { kind: 'repo' as const, key: 'project:mcode', label: 'MCode' }
      ])
    )
    const projectLabelByKey = new Map([['project:mcode', 'Canonical MCode']])
    ...
    ).toEqual([{ key: 'project:mcode', label: 'Canonical MCode', sessions }])
  })
...
describe('parseVaultQuery', () => {
  it('keeps quoted terms together', () => {
    expect(parseVaultQuery('"resume picker" repo:mcode path:src')).toEqual({
      terms: ['resume picker'],
      repoTerms: ['mcode'],
      pathTerms: ['src']
    })

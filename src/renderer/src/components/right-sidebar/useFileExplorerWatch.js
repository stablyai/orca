...
import { purgeDirCacheSubtree, purgeExpandedDirsSubtree, clearStalePendingReveal } from './file-explorer-watcher-reconcile';
/**
 ...
 */
export function useFileExplorerWatch({ worktreePath, activeWorktreeId, dirCache, setDirCache, expanded, setSelectedPath, refreshDir, refreshTree, inlineInput, dragSourcePath }) {
    ...
    useEffect(() => {
        ...
        function processPayload(payload) {
            ...
            for (const dirPath of dirsToRefresh) {
                ...
                if (dirPath === normalizeAbsolutePath(currentWorktreePath) ||
                    exp.has(dirPath) ||

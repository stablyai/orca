...
import { Plug, Files, GitBranch, ListChecks, PanelRight, Workflow, Waves } from 'lucide-react'
  ...
  const activityItems = useMemo<ActivityBarItem[]>(
    () => [
      ...
      },
      {
        id: 'aquarium',
        icon: Waves,
        title: translate('auto.components.right.sidebar.index.aquarium', 'Aquarium'),
        shortcut: ''
      }
    ],

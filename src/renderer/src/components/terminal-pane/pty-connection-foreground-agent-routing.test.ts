...
describe('connectPanePty', () => {
  ...
  it('clears pre-hook launch config when an MCode-started command exits', async () => {
  ...
  it('confirms an MCode-launched Droid fresh spawn in a no-OSC shell (Git Bash)', async () => {

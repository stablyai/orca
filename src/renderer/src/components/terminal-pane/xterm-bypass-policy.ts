...
//
// VS Code's textarea input agrees: it stops propagation only for keyCode 229 and
// Backspace-during-composition, and deliberately still fires Escape to the editor
// (textAreaEditContextInput.ts:201-214).

...
const HAS_CSS_ANCHOR_POSITIONING =
  ...
  CSS.supports('position-anchor', '--mcode-terminal-overlay-probe') &&
  CSS.supports('top', 'anchor(--mcode-terminal-overlay-probe top)') &&
  CSS.supports('width', 'anchor-size(--mcode-terminal-overlay-probe width)')

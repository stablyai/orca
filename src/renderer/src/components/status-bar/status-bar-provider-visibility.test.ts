...
describe('hasUsageProviderSettingsForProvider', () => {
  ...
  it('uses the checked, detected Antigravity item as its durable signal', () => {
    expect(
      hasUsageProviderSettingsForProvider(
        'antigravity',
...
describe('getVisibleUsageProvider', () => {
  ...
  it('keeps Antigravity visible while the snapshot is pending when the CLI is detected', () => {
    const visible = getVisibleUsageProvider(
      'antigravity',
      null,
      usageSettings({ antigravityUsageConfigured: true })
  ...
  it('keeps a checked Antigravity item visible while credentials are unavailable', () => {
    expect(
      getVisibleUsageProvider(
        'antigravity',
        null,
    ...
    expect(
      getVisibleUsageProvider(
        ...
        provider('unavailable', {
          provider: 'antigravity',
          error: 'Antigravity credentials not found'
        }),
        usageSettings({ antigravityUsageConfigured: true })
      )
...
describe('isUsageEmptyState', () => {
  ...
  it('does not show the setup CTA when the detected Antigravity CLI is checked', () => {
    expect(
      isUsageEmptyState(
        {
          claude: provider('unavailable', { provider: 'claude' }),

...
// Cursor Auto/API are first-class lanes (same role as Gemini Flash/Pro).
const STATUS_BAR_BUCKET_NAMES = new Set(['Flash', 'Pro', '1.5 Pro', 'Auto', 'API'])
...
function StatusBarInner({ floatingTerminalOpen }: StatusBarProps): React.JSX.Element | null {
  ...
  // Why: Cursor reads IDE state DB, not a CLI on PATH, so detection-gating doesn't apply.

  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="top" align="end" sideOffset={8} className="min-w-[220px]">
        <DropdownMenuLabel>{translate("auto.components.status.bar.PetStatusSegment.34c25dfe9c", "Pet")}</DropdownMenuLabel>
        <DropdownMenuItem
          onSelect={(event) => {
        ...
        >
          <div className="mb-1 flex items-center justify-between text-[11px] text-muted-foreground">
            <span>{translate("auto.components.status.bar.PetStatusSegment.2f7bbaa457", "Size")}</span>
            <span className="tabular-nums">{petSize}{translate("auto.components.status.bar.PetStatusSegment.c6aa805b1b", "px")}</span>
          </div>
          <input
            type="range"
            min={PET_SIZE_MIN}
        ...
        <DropdownMenuSub>
          <DropdownMenuSubTrigger>{translate("auto.components.status.bar.PetStatusSegment.0608ad02a2", "Choose pet")}</DropdownMenuSubTrigger>
          ...
          <DropdownMenuPortal>
            <DropdownMenuSubContent className="min-w-[220px]">
              ...
              >
                ...
                {translate("auto.components.status.bar.PetStatusSegment.59b5955621", "Upload your own…")}</DropdownMenuItem>
              <DropdownMenuItem
                onSelect={() => {
              ...
              >
                ...
                {translate("auto.components.status.bar.PetStatusSegment.ed176ad68f", "Import .codex-pet bundle…")}</DropdownMenuItem>
            </DropdownMenuSubContent>
          </DropdownMenuPortal>
        </DropdownMenuSub>
        <DropdownMenuSeparator />
        ...
        >
          {translate("auto.components.status.bar.PetStatusSegment.cd8c6c654c", "Pet settings…")}</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  )
}

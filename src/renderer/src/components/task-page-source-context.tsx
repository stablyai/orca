...
export const BUSINESSMAP_ITEM_LIMIT = 30
...
export function getBusinessmapCardWorkspaceSeed(card: BusinessmapCard): string {
  return (
    getLinkedWorkItemWorkspaceName({
      type: 'issue',
      ...
      number: card.id,
      title: card.title
    })?.seedName ?? getLinkedWorkItemSuggestedName(card)
  )
}

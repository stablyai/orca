...
const HOVER_REVEAL_FILES = [
  ...
  resolve(__dirname, 'right-sidebar/pr-comment-row.tsx'),
  resolve(__dirname, 'right-sidebar/source-control-diff-comments-inline-list.tsx'),
  resolve(__dirname, 'right-sidebar/source-control-entry-layout.ts'),

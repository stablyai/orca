...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuPrimitive.SubContent
      ...
      className={cn(
        // Why: this surface ships a near-transparent bg (alpha 0.10/0.12) and
        // relies on backdrop-blur-2xl for legibility. Do not add .glass-surface
        // here — backdrop-filter rules replace rather than compose, and the
        // unlayered .glass-surface would otherwise nuke this blur on non-glass
        // themes (blur(0) over alpha-0.10 background = unreadable).
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          // Why: see ContextMenuSubContent — same rationale, backdrop-blur-2xl
          // is the sole blur source so it survives across all themes.

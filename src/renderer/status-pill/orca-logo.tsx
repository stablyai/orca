...
export function OrcaLogo({
  ...
  // Why: the source viewBox is ~1.57:1 (orca is wider than tall); keep the
  // aspect ratio so the mark isn't squished.
  const height = size
  const width = Math.round(size * 1.57)
  return (
    <svg
      width={width}
      height={height}

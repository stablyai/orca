...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Pass --pull-request to create the checkout from the verified PR head and link the workspace to that PR; it cannot be combined with --base-branch.',
  ...
  },
  {
    ...
    notes: [
      ...
      'Pass --pull-request null to clear the GitHub pull request link.'
    ],
    examples: [

...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'mcode wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage: 'mcode tab profile list [--json]',
  ...
  },
  {
    ...
    usage:
      'mcode tab profile create --label <name> [--scope <isolated|imported>] [--no-ua-spoof] [--json]',

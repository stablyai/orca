...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['serve'],
    summary: 'Start an MCode runtime server without opening a desktop window',
    usage:
    ...
    examples: [
      'mcode serve',
      'mcode serve --json',
      'mcode serve --project-root /workspace/repo --pairing-address wss://sandbox.example.com --recipe-json',
      'mcode serve --port 6768 --pairing-address 100.64.1.20',
      'mcode serve --pairing-address 100.64.1.20 --mobile-pairing'
    ]
  }
]

...
export const SERVE_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'orca serve [--port <port>] [--pairing-address <host>] [--tailcat] [--mobile-pairing] [--no-pairing] [--project-root <path>] [--recipe-json] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'port',
      'pairing-address',
    ...
    notes: [
      ...
      'Use --tailcat to keep the server on loopback and embed a Tailcat tunnel in the runtime pairing link.',

...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'processAction is the close contract: closed_agent_terminal means the pane was closed; none means no close was attempted (already settled, identity changed, unsupervised fence, or process already gone); unknown means the close attempt did not complete. A stop_unknown receipt can still report closed_agent_terminal when a close was issued but the process was not proven dead.',

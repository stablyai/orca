...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      '--model supports Claude, Codex, Cursor, and OpenCode opaque provider model ids. OpenCode does not support --effort; for other agents, --effort requires --model and agent/model support. Neither can combine with --terminal.',

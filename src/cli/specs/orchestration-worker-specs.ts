...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      '--model supports Claude, Codex, Cursor, and Antigravity provider model ids; --effort requires --model. Neither can combine with --terminal.',
      'Antigravity effort must match an effort-specific model ID. Verified Gemini Flash families accept low/medium/high; Gemini 3.1 Pro accepts low/high. Legacy display-name selectors do not accept --effort.',

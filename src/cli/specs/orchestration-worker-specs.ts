...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      '--retry-of links the replacement attempt but does not inherit placement; repeat the intended --on/--worktree and whether to create a new agent terminal or reuse --terminal; --agent/--model/--effort follow the normal Settings > Orchestration default rules.',

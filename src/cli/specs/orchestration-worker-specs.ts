...
export const ORCHESTRATION_WORKER_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    notes: [
      ...
      '--capacity-slot atomically enforces the Run target and requires this ready Task to be explicitly enrolled.'
    ]
  },
  {

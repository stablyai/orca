...
/** Flag help for commands whose CommandSpec carries no flagHelp entry for the flag. */
export function formatLegacyCommandFlagHelp(flag: string, command: string): string {

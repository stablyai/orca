...
import { formatFlagHelp } from './flag-help-table'
import { formatQuickCommandFlagHelp } from './quick-command-flag-help'
...
function formatCommandFlagHelp(flag: string, commandPath: string[]): string {
  ...
  return formatQuickCommandFlagHelp(command, flag) ?? formatFlagHelp(flag)
}

export { formatFlagHelp } from './flag-help-table'

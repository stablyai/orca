...
Common Commands:
  ...
  orca terminal show [--terminal <handle>] [--source auto|visible|transcript] [--json]
  orca terminal read [--terminal <handle>] [--cursor <n>] [--limit <n>] [--source auto|visible|transcript] [--json]

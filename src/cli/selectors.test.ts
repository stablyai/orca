...
function clientWith(call: unknown, options: { isRemote?: boolean } = {}): RuntimeClient {
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: selector tests exercise only RuntimeClient.call and isRemote; RuntimeClient is a class so the focused double is not structurally assignable.

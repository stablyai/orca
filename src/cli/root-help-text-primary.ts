export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  '',
  'Runtime Access:',
  '  runtime-access list       List runtime pairing grants on this host without credentials',
  '  runtime-access revoke     Revoke one grant and disconnect clients using it',
  '',
  'Skills:',

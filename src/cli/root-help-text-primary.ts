export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  '',
  'Quick Commands:',
  '  quick-command list        List saved terminal quick commands',
  '  quick-command show        Show one saved quick command',
  '  quick-command create      Create a terminal quick command',
  '  quick-command set         Update a saved quick command',
  '  quick-command rm          Remove a saved quick command',
  '',
  'Worktrees:',

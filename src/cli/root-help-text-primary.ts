export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  "  orchestration run-settle  Clean a Run's owned child worktrees",
  '  orchestration run-complete Explicitly complete a Run with evidence',
  ...
  '  orchestration replace-worker Replace one outcome-unknown worker atomically',

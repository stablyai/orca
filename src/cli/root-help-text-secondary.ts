export const ROOT_HELP_TEXT_SECONDARY = [
  ...
  '  orca terminal identity-proof begin --worktree <selector> [--json]',
  '  orca terminal identity-proof complete --challenge <id> --title <agent-name> [--json]',
  ...
  '  --challenge <id>          Runtime-issued short-lived terminal identity challenge',

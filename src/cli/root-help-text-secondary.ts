export const ROOT_HELP_TEXT_SECONDARY = [
  ...
  '  orca host list [--json]',
  '  orca environment create --recipe <id> [--name <name>] [--repo-path <path>] [--json]',
  '  orca environment add --name <name> --pairing-code <code> [--json]',
  '  orca environment list [--include-provider-state] [--json]',
  '  orca environment show --environment <selector> [--json]',
  '  orca environment destroy --environment <selector> [--json]',
  '  orca environment rm --environment <selector> [--force] [--json]',

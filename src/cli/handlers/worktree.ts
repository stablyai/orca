...
import { withPublicWorkspaceRecordResponse } from '../worktree-public-identity'
import { WORKTREE_LIST_HANDLERS } from './worktree-list-handlers'
...
export const WORKTREE_HANDLERS: Record<string, CommandHandler> = {
  ...
  'worktree show': async ({ flags, client, cwd, json }) => {
    ...
    printResult(withPublicWorkspaceRecordResponse(result), json, formatWorktreeShow)
  },

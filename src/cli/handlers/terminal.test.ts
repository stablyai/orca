...
describe('terminal close CLI', () => {
  ...
  it('parses --tab and uses the tab-specific RPC without a shell fallback', async () => {
  ...
  it('documents --tab as an explicit whole-tab close', () => {
    ...
    expect(help).toContain('whole renderer tab')
  })
})

...
function testClient(call: unknown): RuntimeClient {
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: executeMissionRun in this suite reaches only call and isRemote on the RuntimeClient double.

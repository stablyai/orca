...
function testClient(call: unknown): RuntimeClient {
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: these attention cases exercise only call and isRemote on the RuntimeClient double.

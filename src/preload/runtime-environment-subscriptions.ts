...
export async function subscribeRuntimeEnvironmentFromPreload(
  ...
  try {
    // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: ipcMain.handle('runtimeEnvironments:subscribe') always returns RuntimeEnvironmentSubscriptionStartResult.

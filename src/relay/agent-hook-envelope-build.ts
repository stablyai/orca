...
export function buildRelayHookEnvelope(
  ...
  return {
    ...
    env,
    version,
    // Already sanitized by the caller: applyEvent clears a cwd that contradicts the worktree
    // before caching or forwarding, so both the live and replay legs reach here with a cwd this
    // host judged keep-worthy.

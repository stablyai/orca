...
export function registerGitHandlers(
  ...
  dispatcher.onRequest('git.commit', (p, context) => handlers.changes.commit(p, context))
  dispatcher.onRequest('git.diff', (p, context) => handlers.read.getDiff(p, context))
  dispatcher.onRequest('git.stage', (p, context) => handlers.changes.stage(p, context))
  dispatcher.onRequest('git.unstage', (p, context) => handlers.changes.unstage(p, context))
  dispatcher.onRequest('git.bulkStage', (p, context) => handlers.changes.bulkStage(p, context))
  dispatcher.onRequest('git.bulkUnstage', (p, context) => handlers.changes.bulkUnstage(p, context))

...
export function registerAutoUpdaterHandlers({ clearAvailableUpdateContext, getCurrentStatus, getKnownReleaseUrl, getPendingInstallVersion, getUserInitiatedCheck, hasNewerDownloadedVersion, performQuitAndInstall, recordCompletedUpdateCheck, sendCheckFailureStatus, sendErrorStatus, sendStatus, scheduleAutomaticUpdateCheck, setAvailableReleaseUrl, setAvailableVersion, setUserInitiatedCheck }) {
    ...
    app.on('before-quit', (event) => {
        ...
        if (deferMacQuitUntilInstallerReady(getCurrentStatus(), hasNewerDownloadedVersion(), getPendingInstallVersion, sendStatus)) {

...
export class DatabaseSshConnectionRoute {
  ...
  private portForwardManager: SshPortForwardManager | null = null

  constructor(dependencies: Partial<DatabaseSshConnectionRouteDependencies> = {}) {
    this.dependencies = {
      getConnectionManager:
        dependencies.getConnectionManager ?? (async () => getSshConnectionManager()),
      getPortForwardManager:
        dependencies.getPortForwardManager ??
        (async () => (this.portForwardManager ??= new SshPortForwardManager())),

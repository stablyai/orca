...
// daemon-side fact authority): MCODE_DAEMON_BACKGROUND_STREAM_DROP=0.
export const BACKGROUND_STREAM_DROP_ENABLED = process.env.MCODE_DAEMON_BACKGROUND_STREAM_DROP !== '0'

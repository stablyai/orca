...
// Why: must stay under DAEMON_MAX_ACTIVE_REQUEST_BYTES_PER_CLIENT — the seed rides inside one
// createOrAttach request line. The checkpoint writer may produce more than this, so the seed is
// clamped at the producer (clampHistorySeed) rather than raised here.

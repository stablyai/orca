...
// v36 makes destructive PTY shutdown incarnation-addressed; older owners stay attachable.
export const PROTOCOL_VERSION = 36
export const INCARNATION_ADDRESSED_SHUTDOWN_DAEMON_PROTOCOL_VERSION = 36

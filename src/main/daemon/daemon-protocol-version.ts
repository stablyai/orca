...
// v37 makes completion-sensitive process inspection fail closed; older owners stay attachable.
export const PROTOCOL_VERSION = 37
export const AUTHORITATIVE_COMPLETION_PROCESS_INSPECTION_PROTOCOL_VERSION = 37

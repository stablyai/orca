...
// v37 consumes the Windows post-profile default-home marker; older owners stay attachable.
export const PROTOCOL_VERSION = 37
export const CODEX_DEFAULT_HOME_AFTER_PROFILE_DAEMON_PROTOCOL_VERSION = 37

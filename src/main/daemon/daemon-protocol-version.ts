...
// v37 fences attach-only requests by exact session incarnation before side effects.
export const PROTOCOL_VERSION = 37
export const SESSION_INCARNATION_ATTACH_FENCE_DAEMON_PROTOCOL_VERSION = 37

...
// v37 carries explicit host-runtime authority; older owners stay attachable for requests that do not use it.
export const PROTOCOL_VERSION = 37
export const FORCE_HOST_RUNTIME_DAEMON_PROTOCOL_VERSION = 37

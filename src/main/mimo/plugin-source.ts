export function getMimoPluginSource(): string {
  // Why: the plugin runs inside the Mimo Node process and POSTs to the
  ...
  // env vars that Orca injects into every PTY, so Mimo panes flow into
  ...
  return [
    ...
    '  const url = `http://127.0.0.1:${coords.port}/hook/mimo`;',
    ...
    '}',
    '',
    'export const OrcaMimoStatusPlugin = async (_ctx) => {',

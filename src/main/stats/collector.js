...
export class StatsCollector {
    events;
    aggregates;
    liveAgents = new Map(); // ptyId → startTimestamp
    writeTimer = null;
    constructor() {
    ...
    onAgentStart(ptyId, at, repoId, worktreeId) {

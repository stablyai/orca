...
export const mainProcessState = {
  ...
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: widens the inferred field type so startup phases can assign the store after creation.

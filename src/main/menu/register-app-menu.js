...
export function registerAppMenu({ onOpenSettings, onCheckForUpdates, onZoomIn, onZoomOut, onZoomReset, onToggleStatusBar }) {
    const reloadFocusedWindow = (ignoreCache) => {

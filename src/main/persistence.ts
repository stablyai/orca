...
>(updates: T): T {
  ...
  if ('upstream' in sanitized && sanitized.upstream != null) {
    const upstream = sanitized.upstream as { owner?: unknown; repo?: unknown }
    if (typeof upstream.owner !== 'string' || typeof upstream.repo !== 'string') {

...
describe('Store', () => {
  ...
  it('returns default settings when no data file exists', async () => {
    ...
    expect(settings.browserInteractionMode).toBe('agent')
    expect(settings.browserPermissionDefaults).toEqual({})
    expect(settings.browserSitePermissionRules).toEqual([])
    expect(settings.browserPermissionNoticePolicy).toBe('important-only')
  ...
  it('merges loaded data with defaults for missing fields', async () => {
    ...
    expect(store.getSettings().browserInteractionMode).toBe('agent')
    expect(store.getSettings().browserPermissionDefaults).toEqual({})
    expect(store.getSettings().browserSitePermissionRules).toEqual([])
    expect(store.getSettings().browserPermissionNoticePolicy).toBe('important-only')

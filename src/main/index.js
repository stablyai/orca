...
import { configureDevUserDataPath, enableMainProcessGpuFeatures, installDevParentDisconnectQuit, installDevParentWatchdog, installUncaughtPipeErrorGuard, patchPackagedProcessPath } from './startup/configure-process';
...
function openMainWindow() {
    ...
    registerCoreHandlers(store, runtime, stats, claudeUsage, codexUsage, codexAccounts, rateLimits, window.webContents.id);
    attachMainWindowServices(window, store, runtime, () => codexAccounts.getSelectedManagedHomePath());

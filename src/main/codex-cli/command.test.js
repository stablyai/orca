...
describe('resolveCodexCommand', () => {
    ...
    it('prefers Codex already present on PATH', () => {
        ...
        expect(resolveCodexCommand({ platform: 'darwin', pathEnv: pathDir, homePath: root })).toBe(commandPath);
    });
...
describe('resolveClaudeCommand', () => {
    ...
    it('prefers claude already present on PATH', () => {
        ...
        makeExecutable(commandPath);
        expect(resolveClaudeCommand({ platform: 'darwin', pathEnv: pathDir, homePath: root })).toBe(commandPath);
    });

...
// Re-exported so existing importers of worktree-logic keep their import paths;
// the worktree removal/orphan error helpers now live in their own module.
export {
  formatWorktreeRemovalError,
  isOrphanCompatiblePreflightError,
  isOrphanedWorktreeError
} from './worktree-removal-error'

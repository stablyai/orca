...
export function registerNotificationHandlers(store) {
    ...
    ipcMain.handle('notifications:dispatch', (_event, args) => {
        ...
        if ((args.source === 'agent-task-complete' && !settings.agentTaskComplete) ||
 ...
 */
export function triggerStartupNotificationRegistration(store) {
...
function buildNotificationOptions(args) {

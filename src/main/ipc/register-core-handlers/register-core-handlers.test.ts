...
const {
  ...
  registerShortcutHandlersMock: vi.fn(),
...
vi.mock('../shortcut', () => ({
  registerShortcutHandlers: registerShortcutHandlersMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerShortcutHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', async () => {
    ...
    expect(registerShortcutHandlersMock).toHaveBeenCalled()

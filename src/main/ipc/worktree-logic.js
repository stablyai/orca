 ...
 */
export function ensurePathWithinWorkspace(targetPath, workspaceDir) {
 ...
 */
export function computeBranchName(sanitizedName, settings, gitUsername) {
 ...
 */
export function computeWorktreePath(sanitizedName, repoPath, settings) {
    const pathOps = looksLikeWindowsPath(repoPath) || looksLikeWindowsPath(settings.workspaceDir)
        ? win32
        : { basename, join };
...
export function areWorktreePathsEqual(leftPath, rightPath, platform = process.platform) {
 ...
 */
export function shouldSetDisplayName(requestedName, branchName, sanitizedName) {
 ...
 */
export function mergeWorktree(repoId, git, meta, defaultDisplayName) {
 ...
 */
export function isOrphanedWorktreeError(error) {
 ...
 */
export function formatWorktreeRemovalError(error, worktreePath, force) {

...
import { registerSshPtyProvider, unregisterSshPtyProvider, getSshPtyProvider, getPtyIdsForConnection, clearPtyOwnershipForConnection, clearProviderPtyState, deletePtyOwnership } from './pty';
import { registerSshFilesystemProvider, unregisterSshFilesystemProvider, getSshFilesystemProvider } from '../providers/ssh-filesystem-dispatch';
import { registerSshGitProvider, unregisterSshGitProvider } from '../providers/ssh-git-dispatch';
export function cleanupConnection(targetId, activeMultiplexers, initializedConnections, portForwardManager) {
...
export function wireUpSshPtyEvents(ptyProvider, getMainWindow) {
...
const reestablishAbortControllers = new Map();
export async function reestablishRelayStack(targetId, getMainWindow, connectionManager, activeMultiplexers, portForwardManager) {
    ...
    try {
        ...
        console.warn(`[ssh] Failed to re-establish relay for ${targetId}: ${err instanceof Error ? err.message : String(err)}`);
    }
    finally {

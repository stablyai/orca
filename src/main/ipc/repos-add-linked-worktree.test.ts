...
const MAIN_CHECKOUT = '/Users/dev/projects/mcode'
const LINKED_WORKTREE = '/Users/dev/mcode/workspaces/mcode/pr-3235'
...
describe('repos:add with git worktrees', () => {
  ...
  it('matches the tracked main checkout across path separator differences', async () => {
    mockStore.getRepos.mockReturnValue([
      { ...trackedMainRepo(), path: 'C:\\Users\\dev\\projects\\mcode' } as Repo
    ])
    getLinkedWorktreeMainRepoRootMock.mockReturnValue('C:/Users/dev/projects/mcode')

...
import { registerPanelCanvasPopoutHandlers } from './panel-canvas-popout'
...
import { registerPetPresenceHandlers } from './pet-presence'
...
export function registerCoreHandlers(
  ...
  registerPanelCanvasPopoutHandlers()

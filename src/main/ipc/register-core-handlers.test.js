...
const { registerCliHandlersMock, registerPreflightHandlersMock, registerClaudeUsageHandlersMock, registerCodexUsageHandlersMock, registerGitHubHandlersMock, registerStatsHandlersMock, registerNotificationHandlersMock, registerSettingsHandlersMock, registerShellHandlersMock, registerSessionHandlersMock, registerUIHandlersMock, registerFilesystemHandlersMock, registerRuntimeHandlersMock, registerCodexAccountHandlersMock, registerClipboardHandlersMock, registerUpdaterHandlersMock, registerRateLimitHandlersMock, registerBrowserHandlersMock, setTrustedBrowserRendererWebContentsIdMock, registerFilesystemWatcherHandlersMock } = vi.hoisted(() => ({
...
describe('registerCoreHandlers', () => {
    ...
    it('passes the store through to handler registrars that need it', () => {
        ...
        registerCoreHandlers(store, runtime, stats, claudeUsage, codexUsage, codexAccounts, rateLimits);
    ...
    it('only registers IPC handlers once but always updates web contents id', () => {
        ...
        registerCoreHandlers(store2, runtime2, stats2, claudeUsage2, codexUsage2, codexAccounts2, rateLimits2, 42);

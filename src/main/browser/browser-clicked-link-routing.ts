...
type BrowserClickedLinkRoutingGlobal = typeof globalThis & {
  __mcodeBrowserClickedLinkRouting?: BrowserClickedLinkRoutingState
}
...
export function installBrowserClickedLinkRouting(
  ...
  const existing = routingGlobal.__mcodeBrowserClickedLinkRouting
  if (existing) {
  ...
  state.listener = (event) => {
    ...
    // opener-dependent window flows in MCode's guarded popup window.
  ...
  routingGlobal.__mcodeBrowserClickedLinkRouting = state

...
/**
 * Hosts a guest-opened popup inside an MCode-built window whose top strip is a
 * separate, MCode-controlled WebContentsView showing the popup's current
...
export function openPopupWithOriginBar(
  ...
  // Why: the origin bar renders only MCode's own data: URL and must stay

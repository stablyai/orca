export function getStatusPluginDeliverySource(): string[] {
  return [
    ...
    '  factoryID',
    ') {',
    '  const rootFields = rootTurnFields(targetProperties?.sessionID);',
    '  const extraProperties = { ...(targetProperties || {}), ...rootFields };',
    '  // Why: a root ending under an unchanged aggregate (a child still busy) must re-post.',
    '  const nextKey =',
    '    targetKey + ":" + JSON.stringify([rootFields.root_state, rootFields.root_turn_error_name || ""]);',

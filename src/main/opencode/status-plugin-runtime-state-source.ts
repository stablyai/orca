export function getStatusPluginRuntimeStateSource(): string[] {
  return [
    ...
    '// Why: an erroring root turn publishes session.error before its Idle, and a',
    '// recoverable overflow publishes one and keeps working; root work clears it.',
    'const rootTurnErrorNameBySessionID = new Map();',

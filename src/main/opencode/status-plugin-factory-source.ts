  ...
  return [
    ...
    ...(options.emitSessionStart
      ? [
          ...
          '        disposed ? undefined : post("SessionStart", { sessionID: info.id, ...rootTurnFields(info.id) })',
          '      );',
          '      return;',
          '    }',
          ''
    ...
    '      }',
    '      for (const [sessionID, error] of rootTurnErrorNameBySessionID) {',
    '        if (error.factoryID === factoryID) rootTurnErrorNameBySessionID.delete(sessionID);',
    '      }',

...
export function mapCheckRunRESTStatus(status) {
...
export function mapCheckRunRESTConclusion(status, conclusion) {
...
export function mapCheckStatus(state) {
...
export function mapCheckConclusion(state) {
    const s = state?.toUpperCase();
    if (s === 'SUCCESS' || s === 'PASS') {
        return 'success';
    }
...
export function mapPRState(state, isDraft) {
    const s = state?.toUpperCase();
    if (s === 'MERGED') {
        return 'merged';
    }
...
export function deriveCheckStatus(rollup) {

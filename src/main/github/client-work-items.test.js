...
const { execFileAsyncMock, ghExecFileAsyncMock, getOwnerRepoMock, gitExecFileAsyncMock, acquireMock, releaseMock } = vi.hoisted(() => ({
...
describe('listWorkItems', () => {
    ...
    it('runs both issue and PR GitHub searches for a mixed query and merges the results by recency', async () => {
        ...
        expect(ghExecFileAsyncMock).toHaveBeenNthCalledWith(1, [
            'issue',
            'list',
            '--limit',
            '10',
        ...
        expect(ghExecFileAsyncMock).toHaveBeenNthCalledWith(2, [
            'pr',
            'list',
            '--limit',
            '10',

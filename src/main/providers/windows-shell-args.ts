...
export const MCODE_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV = 'MCODE_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined MCODE_CODEX_LAUNCH_PREFLIGHT call %${MCODE_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%MCODE_CODEX_LAUNCH_PREFLIGHT%%${MCODE_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment MCode detects.

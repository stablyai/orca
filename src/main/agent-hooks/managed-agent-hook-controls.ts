...
// MCode's script, but the presence gate below then skips install() forever, freezing the
// script at whatever MCode generated last. Existing scripts are MCode-owned, so bring them

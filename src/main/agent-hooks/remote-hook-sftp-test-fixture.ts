...
export function createRemoteHookFakeSftp(initialFiles: Record<string, string> = {}): {
  sftp: SFTPWrapper
  fs: RemoteHookFakeFs
} {
  ...
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: The fixture implements every SFTP method exercised by remote hook installers.
  return { sftp: sftp as unknown as SFTPWrapper, fs }
}

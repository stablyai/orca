...
// In-memory SFTP double shared by the remote managed-hook installer tests, so each
// agent's installRemote is exercised against one implementation of the wire contract.
export type FakeFs = {

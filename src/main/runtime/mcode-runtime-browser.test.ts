...
import type { RuntimeBrowserCommandHost } from './mcode-runtime-browser'
    ...
    profiles: new Map([
      ...
      [
        'profile-isolated',
        {
          id: 'profile-isolated',
          scope: 'isolated',
          partition: 'persist:mcode-browser-session-profile-isolated',
          label: 'Isolated',
          source: null
        }
      ]
...
describe('RuntimeBrowserCommands browser screencast', () => {
  ...
  it('creates profiles with the requested user-agent mode', async () => {
    const { RuntimeBrowserCommands } = await import('./mcode-runtime-browser')
    const profile = {
      id: 'profile-google',
      scope: 'isolated',

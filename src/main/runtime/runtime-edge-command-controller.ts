...
import { RuntimeOdooCommands } from './runtime-odoo-commands'
...
export type RuntimeEdgeCommandSurface = BrowserSurface &
  ...
  PublicMethods<RuntimeOdooCommands> &
...
export class RuntimeEdgeCommandController {
  ...
  private readonly odoo = new RuntimeOdooCommands()
  ...
  constructor(args: {
    ...
    this.surface = {
      ...
      ...bindPrefixedMethods(this.odoo, 'odoo'),

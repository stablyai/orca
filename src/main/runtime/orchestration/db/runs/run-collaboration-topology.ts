...
export function getRunCollaborationTopology(
  ...
  // oxlint-disable-next-line typescript/consistent-type-assertions -- SAFETY: the SELECT projects the non-null topology column defined by run_collaboration_topologies.
  const row = this.db

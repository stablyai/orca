...
/**
 * Unread mail for this mailbox that an outstanding batch does not contain.
 *
 * An unacknowledged Delivery replays verbatim for as long as it is held, so without this a worker

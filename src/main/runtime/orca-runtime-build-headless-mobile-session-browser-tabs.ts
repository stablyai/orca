...
export class OrcaRuntimeWithBuildHeadlessMobileSessionBrowserTabs extends OrcaRuntimeWithPersistTerminalSurfaceRetirements {
  ...
  protected closeTerminalSurface(
    ...
    const result = closeTerminalSurfaceInWorkspaceSession(session, worktreeId, target, {
      ...options,
  ...
  closeTerminalSurfaceFromRenderer(
    ...
    this.closeTerminalSurface(worktreeId, target, { allowMissing: true, force: true, reason })
  }

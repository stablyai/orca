...
// out. `startKeepalive` is opt-in per request — long-polls and the slow
// methods in KEEPALIVE_ONLY_METHODS call it, so short RPCs pay no timer
// overhead. See design doc §3.1.

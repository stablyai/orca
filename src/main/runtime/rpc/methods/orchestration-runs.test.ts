...
describe('orchestration RPC methods', () => {
  ...
  it('registers all expected methods', () => {
    ...
    expect(registry.has('orchestration.capacityConfigure')).toBe(true)
    expect(registry.has('orchestration.capacityShow')).toBe(true)
    expect(registry.has('orchestration.capacityTaskSet')).toBe(true)
  })

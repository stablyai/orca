    ...
    handler: async (params, { runtime }) => {
      ...
      try {
        const result = await runtime.createManagedWorktree({
          ...
          linkedIssueSourcePreference: params.linkedIssueSourcePreference,
          ...
          linkedJiraIssue: params.linkedJiraIssue,
          linkedJiraIssueSiteId: params.linkedJiraIssueSiteId,
          linkedGitLabMR: params.linkedGitLabMR,
          linkedGitLabIssue: params.linkedGitLabIssue,
          linkedGitLabProjectRef: params.linkedGitLabProjectRef,

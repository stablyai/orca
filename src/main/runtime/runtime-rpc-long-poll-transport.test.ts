...
describe('OrcaRuntimeRpcServer', () => {
  ...
  describe('long-poll transport (§3.1)', () => {
    ...
    // Why: guards #8884 — accounts.list's forced refresh is a slow serial
    // round-trip on a cold host, so it needs keepalives to survive the idle
    // timeout, but must never occupy a terminal.wait/check-wait admission slot.

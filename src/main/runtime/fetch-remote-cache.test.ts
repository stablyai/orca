...
// `MCodeRuntimeService.fetchRemoteWithCache` — in particular that a rejected
...
// without disturbing the large mcode-runtime.test.ts mock surface.
...
// Why: mcode-runtime.ts imports heavy modules (hooks, ipc/*, etc.) at top
...
describe('MCodeRuntimeService.fetchRemoteWithCache', () => {
  beforeEach(() => {

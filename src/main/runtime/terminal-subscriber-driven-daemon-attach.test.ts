 ...
 *
 * Harness: real MCodeRuntimeService + real TERMINAL_METHODS multiplex handler,
 ...
 * assertion also holds for headless `mcode serve`.
 */
...
function startMultiplex(runtime: MCodeRuntimeService, connectionId = 'conn-desktop') {

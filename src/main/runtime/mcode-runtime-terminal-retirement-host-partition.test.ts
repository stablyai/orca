...
function syncSshSplit(runtime: MCodeRuntimeService, snapshot: RuntimeMobileSessionTabsSnapshot) {
...
describe('MCodeRuntimeService terminal retirement host partitioning (STA-3463)', () => {
  it('retires an exited SSH pane from the SSH partition and leaves the local partition untouched', async () => {
    ...
    const runtime = new MCodeRuntimeService(harness.store)

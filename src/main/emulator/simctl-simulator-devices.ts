...
/**
 * Maps simctl failures to stable emulator error codes.
 * @param error Process execution failure.
 * @param stderr Optional diagnostic output from simctl.
 * @returns An emulator error suitable for RPC transport.
 */

...
/** Applies global settings updates and normalizes values before they are saved. */
export function updateSettings(
  ...
  if ('nativeChatSendShortcut' in updates) {
    sanitizedUpdates.nativeChatSendShortcut = normalizeNativeChatSendShortcut(
      updates.nativeChatSendShortcut
    )
  }

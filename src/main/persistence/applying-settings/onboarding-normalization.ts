...
export function normalizeNotificationSettings(value: unknown): NotificationSettings {
  ...
  return {
    ...
    cliWorktreeTaskComplete: booleanOr(candidate.cliWorktreeTaskComplete, true),
    automationWorktreeTaskComplete: booleanOr(candidate.automationWorktreeTaskComplete, true),

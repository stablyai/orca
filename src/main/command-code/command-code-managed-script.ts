...
export function buildCommandCodeManagedScript(
  ...
  return [
    ...
    '    ORCA_AGENT_STATUS_RUN_ID) [ -z "${ORCA_AGENT_STATUS_RUN_ID:-}" ] || return 0 ;;',
    '    ORCA_AGENT_STATUS_EXECUTION_ID) [ -z "${ORCA_AGENT_STATUS_EXECUTION_ID:-}" ] || return 0 ;;',
    '    *) return 0 ;;',
    '  esac',
    ...
    'for __orca_name in ORCA_AGENT_HOOK_ENDPOINT ORCA_AGENT_HOOK_PORT ORCA_AGENT_HOOK_TOKEN ORCA_AGENT_HOOK_ENV ORCA_AGENT_HOOK_VERSION ORCA_PANE_KEY ORCA_TAB_ID ORCA_WORKTREE_ID ORCA_AGENT_LAUNCH_TOKEN ORCA_AGENT_STATUS_RUN_ID ORCA_AGENT_STATUS_EXECUTION_ID; do',

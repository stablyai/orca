...
export const TEST_REPO_MCODE_YAML_PATH = join(TEST_REPO_PATH, 'mcode.yaml')
export const TEST_WORKTREE_MCODE_YAML_PATH = join(TEST_WORKTREE_PATH, 'mcode.yaml')
export const TEST_ISSUE_COMMAND_PATH = join(TEST_REPO_PATH, '.mcode', 'issue-command')

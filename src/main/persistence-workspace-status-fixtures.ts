export const REORDERED_DEFAULT_WORKSPACE_STATUSES = [
...
export const REORDERED_DONE_DEFAULT_WORKSPACE_STATUSES = [
...
export const LEGACY_DEFAULT_WORKSPACE_STATUSES = [
  { id: 'todo', label: 'Todo', color: 'neutral', icon: 'circle' },
...
export const WORKFLOW_DEFAULT_WORKSPACE_STATUSES = [
  { id: 'todo', label: 'Todo', color: 'neutral', icon: 'circle' },
  {
    id: 'in-progress',
    label: 'In progress',

...
/** True for Codex rollout logs: `*.jsonl` or cold-compressed sibling `*.jsonl.zst`. */
...
/**
 * Basename without rollout suffixes (`.jsonl` / `.jsonl.zst`) so UUID extraction
 * still works for compressed cold sessions.
 */

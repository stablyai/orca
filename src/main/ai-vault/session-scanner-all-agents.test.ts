...
import {
  isolatedScanRoots,
  jsonLines,
  writeAntigravityConversationDb
...
describe('scanAiVaultSessions all-agent coverage', () => {
  it('indexes every supported agent transcript format with native resume commands', async () => {
    ...
    writeAntigravityConversationDb({
      dir: roots.antigravityConversationsDir,
      conversationId: 'a0000000-0000-4000-8000-00000000000a',
      workspaceUri: 'file:///tmp/antigravity',
      userText: 'Antigravity title',
      unixSeconds: 1_781_850_000
    })
    ...
    expect(commandByAgent.get('antigravity')).toBe(
      "cd '/tmp/antigravity' && agy --conversation 'a0000000-0000-4000-8000-00000000000a'"
    )

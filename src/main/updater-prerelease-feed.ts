...
const ATOM_FEED_URL = 'https://github.com/mcode-ide/mcode/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/mcode-ide/mcode/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/stablyai\/mcode\/releases\/tag\/([^"]+)"/g

// Why: Codex 0.133 renames features.codex_hooks → features.hooks. Mirror into
// Orca's runtime config using the new key without rewriting the user's real config.

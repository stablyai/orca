...
export function getPiTitlebarExtensionSource(): string {
  return [
    ...
    '      frameIndex++',
    '      } catch {',
    '        // Session reload invalidated this extension ctx. Stop the timer instead',
    '        // of letting the stale-ctx exception escape as an uncaughtException',
    '        // (which kills the whole pi process).',
    '        if (timer) {',
    '          clearInterval(timer)',
    '          timer = null',
    '        }',

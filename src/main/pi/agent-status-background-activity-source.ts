...
export function getPiAgentStatusBackgroundActivitySourceLines(
  ...
  return {
    ...
    functions: [
      ...
      '    try {',
      '      const manager = (ctx as { sessionManager?: { getSessionFile?: () => unknown; getSessionId?: () => unknown } } | null)?.sessionManager',
      ...
      '  }',
      '',
      '  function restoreBackgroundActivity(ctx: unknown, recovering: boolean): void {',

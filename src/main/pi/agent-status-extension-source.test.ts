...
describe('getPiAgentStatusExtensionSource', () => {
  ...
  // OMP is excluded on purpose: it settles on its own agent_end contract, covered in
  // agent-status-extension-omp-lifecycle.test.ts.
  it('keeps reporting idle-context agents once their agent_end handlers settle', async () => {
    vi.useFakeTimers()
    try {

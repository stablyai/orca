...
// Why: the existing-review lookup behind Create must tell a real transport/auth
// failure apart from an accepted "no PR", so it opts into throwing instead.

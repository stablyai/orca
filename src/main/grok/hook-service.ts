...
export class GrokHookService {
  ...
  remove(): AgentHookInstallStatus {
    ...
    // untouched (no dir/file creation, no reformat of a user-authored hook
    // config, no .bak roll). Mirrors install()'s stale-check retry against
    // concurrent Grok writes. A parse failure is surfaced by getStatus() below.

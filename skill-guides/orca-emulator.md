...
| Multi-step gesture         | `ORCA emulator gesture '<json>'` (Unix) or `ORCA emulator gesture "<json>"` (Windows, escaping inner quotes) | See gestures reference (begin/move/end). Use tap for singles. |

...
- **[Maestro Canvas](https://www.onorca.dev/docs/cli/orchestration#maestro-canvas)** — See Tasks, Attempts, agents, terminals, Browser pages, dependencies, and recovery state in one workspace map.

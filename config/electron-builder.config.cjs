...
module.exports = {
  ...
  asarUnpack: [
    ...
    'out/cli/**',
    'out/shared/**',
    // Why: everything the agent-hooks registry graph imports must live in the
    // unpacked tree — the skills CLI runs it with plain node, which cannot read
    // modules out of the asar.
    ...
    'out/main/startup/hydrate-shell-path.js',

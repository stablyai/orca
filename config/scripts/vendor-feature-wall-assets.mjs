...
const DEFAULT_MARKETING_REPO = path.join(
  ...
  'repos',
  'Stably',
  'mcode-marketing-website'
)
const MARKETING_REPO = process.env.MCODE_MARKETING_REPO || DEFAULT_MARKETING_REPO
...
const TILES = [
  ...
  {
    id: 'tile-03',
    gifRelativePath: 'public/whats-new/mcode-github.gif',
    posterRelativePath: 'public/whats-new/posters/mcode-github.jpg'
  },
  {
    id: 'tile-04',
  ...
  {
    id: 'tile-05',
    gifRelativePath: 'public/whats-new/mcode-design-mode.gif',
    posterRelativePath: 'public/whats-new/posters/mcode-design-mode.jpg'
  },
  {
    id: 'tile-06',
  ...
  {
    id: 'tile-09',
    gifRelativePath: 'public/whats-new/mcode-cli-demo.gif',
    posterRelativePath: 'public/whats-new/posters/mcode-cli-demo.jpg'
  },
  {
    id: 'tile-10',
  ...
  {
    id: 'tile-12',
    gifRelativePath: 'public/whats-new/mcode-markdown-editor.gif',
    posterRelativePath: 'public/whats-new/posters/mcode-markdown-editor.jpg'
  }
]

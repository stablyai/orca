// Why: machine translation renders product names as common words (Codex→法典,
// Gemini→双子座). Each locale maps a protected brand to the wrong forms MT emits
// so repairs can restore the Latin brand text.
export const BRAND_MISTRANSLATIONS = {
  ...
  'zh-TW': {
    ...
    Markdown: ['降價'],
    markdown: ['降價'],
    Repo: ['儲存庫', '存儲庫', '倉庫', '回購協議', '回購'],
    Repos: ['儲存庫', '存儲庫', '倉庫', '回購協議', '回購'],
    repo: ['儲存庫', '存儲庫', '倉庫', '回購協議', '回購'],
    repos: ['儲存庫', '存儲庫', '倉庫', '回購協議', '回購'],
    Terminal: ['終端機', '終端', '端子'],
    Terminals: ['終端機', '終端', '端子'],

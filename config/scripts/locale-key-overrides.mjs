...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'MCode 모바일 버튼 표시',
    zh: '显示 MCode Mobile 按钮',
    ja: 'MCode Mobile ボタンを表示'
  },
  ...
  'menu.exploreMCode': { ko: 'MCode 둘러보기', zh: '探索 MCode', ja: 'MCode を探索' },
  ...
  // Onboarding pill beside MCode Mobile: "New" marks a new feature, not a create action.

...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'auto.components.sidebar.WorktreeOpenInMenu.8009ab69a6': { ja: 'アプリで開く', pt: 'Abrir no' },
  // "Assigned to me" filter; the MT past-passive 割り当てられました reads as a sentence, not a filter label.
  'auto.components.TaskPage.94f0339621': { ja: '私に割り当てられた Issue', pt: 'Atribuído a mim' },
  // aria-label describing the assignee picker state; the past-passive sentence reads oddly for a static label.
  'auto.components.TaskPage.bb63046423': {
    ja: '{{value0}} に割り当て済み',
    pt: 'Atribuído a {{value0}}'
  },
  // Bare "Cursor" terminal/theme settings = on-screen カーソル, not the Cursor product.
  'auto.components.settings.TerminalWindowSection.c9e1fdf42f': { ja: 'カーソル', pt: 'Cursor' },
  'auto.components.onboarding.ThemeStep.ab2a583a97': { ja: 'カーソル', pt: 'Cursor' },
  'menu.reportCrash': {
    ko: '크래시 신고...',
    zh: '报告崩溃...',
    ja: 'クラッシュを報告...',
  ...
  'menu.showMobileButton': {
    ...
    ja: 'Orca モバイル ボタンを表示',
    pt: 'Mostrar Botão do Orca Mobile'
  },
  'menu.toggleLeftSidebar': {
    ko: '왼쪽 사이드바 표시/숨기기',
    zh: '显示/隐藏左侧边栏',
    ja: '左サイドバーの表示/非表示',
    pt: 'Alternar Barra Lateral Esquerda'
  },
  'menu.toggleRightSidebar': {
    ko: '오른쪽 사이드바 표시/숨기기',
    zh: '显示/隐藏右侧边栏',
    ja: '右サイドバーの表示/非表示',
    pt: 'Alternar Barra Lateral Direita'
  },
  'menu.openWorktreePalette': {
    ko: '워크트리 팔레트 열기',
    zh: '打开工作树面板',
    ja: 'ワークツリーパレットを開く',
    pt: 'Abrir Paleta de Worktree'
  },
  'menu.exploreOrca': {
    ko: 'Orca 둘러보기',
    zh: '探索 Orca',
  ...
  'worktreeJumpPalette.matchLabel.issue': { ko: '이슈', zh: '议题', ja: 'Issue', pt: 'Issue' },
  'worktreeJumpPalette.matchLabel.comment': {
    ko: '댓글',
    zh: '评论',
    ja: 'コメント',
    pt: 'Comentário'
  ...
  'settings.appearance.statusBar.kimiToggleDescription': {
    ...
    ja: 'Kimi サブスクリプション',
    pt: 'Mostra o uso da assinatura Kimi no workspace ativo.'
  },
  'auto.components.mobile.MobileHero.cd4e5e816f': {
    ko: '주머니 속의 워크스페이스.',
    zh: '您的工作区就在您的口袋里。',
    ja: 'ワークスペースをポケットに。',
    pt: 'O workspace no seu bolso.'
  },
  ...
  'auto.components.JiraIssueWorkspace.857bd2f88f': {
    ...
    pt: 'Visualize, edite e comece a trabalhar a partir da issue selecionada.'
  },
  ...
  'auto.components.settings.CommitMessageAiPane.4f722a5f53': {
    ...
    pt: 'Usado por receitas de mensagem de commit, PR e nome de branch que selecionam um comando personalizado. Use'
  },
  'auto.components.settings.AgentsPane.9bccf48906': {
    ko: '에이전트 위치',
    zh: '代理位置',
    ja: 'エージェントの場所',
    pt: 'Localização do agente'
  },
  ...
  'auto.components.right.sidebar.source.control.primary.action.3d5dccef0b': {
    ...
    pt: 'Nada para commit. O PR já foi mesclado.'
  },
  'auto.components.settings.integrations.search.16a486a49d': {
    ...
    pt: 'Conecte-se ao Linear para navegar e vincular issues.'
  },
  'menu.showTitlebarAppName': {
    ko: '제목 표시줄 앱 이름 표시',
    zh: '显示标题栏应用名称',
    ja: 'タイトルバーのアプリ名を表示',
    pt: 'Mostrar nome do app na barra de título'
  },
  'auto.App.e81217c1b7': {
    ko: '앱 이름 숨기기',
    zh: '隐藏应用名称',
    ja: 'アプリ名を非表示',
    pt: 'Ocultar nome do app'
  },
  'auto.components.settings.ExperimentalPane.0277901cf7': {
    ...
    pt: 'Adiciona itens de agente à barra lateral esquerda com feed de worktree em thread para agentes concluídos, perguntas bloqueadas, estado não lido e eventos de criação de worktree. Experimental — o modelo de eventos e a UI podem mudar.'
  },
  ...
  'auto.components.TaskPage.6775c05483': {
    ...
    pt: 'Falha ao atualizar o estado do Linear'
  },
  'auto.components.TaskPage.25ff84769a': {
    ...
    pt: 'Nenhuma issue corresponde a este contexto do Linear.'
  },
  'auto.components.settings.IntegrationsPane.33ae9730a8': {
    ...
    pt: 'Adicione acesso ao Linear para navegar e vincular issues.'
  },
  ...
  'auto.components.settings.IntegrationsPane.c0c8575e05': {
    ...
    pt: 'Instale o GitHub CLI para ativar PRs, issues e verificações.'
  },
  ...
  'auto.components.mobile.slides.TerminalSlide.985373052e': {
    ...
    zh: '切换到手机模式',
    ja: 'スマートフォンモードに切り替え',
    pt: 'Alternar para modo telefone'
  },
  'auto.components.GitHubItemDialog.a341343303': {
    ko: '리뷰 댓글이 추가되었습니다.',
    zh: '已添加评审评论。',
    ja: 'レビューコメントを追加しました。',
    pt: 'Comentário de revisão adicionado.'
  },

...
export const ZH_VALUE_OVERRIDES = {
  ...
  'MCode IDE': 'MCode IDE',
  'MCode first': 'MCode 优先',
  'MCode Mobile': 'MCode Mobile',
  'MCode logo': 'MCode 标志',
  'Enjoying MCode?': '喜欢 MCode 吗？',
  'Get to know MCode': '了解 MCode',
  'Expand MCode': '展开 MCode',
  'Support MCode': '支持 MCode',
  'Restarting MCode…': '正在重启 MCode…',
  'Show MCode Mobile Button': '显示 MCode Mobile 按钮',
  ...
  'Proxy Command': '代理命令',
  "Give agents direct access to MCode's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 MCode 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from MCode. It is still on your disk.': '来自 MCode。它仍保留在您的磁盘上。',
